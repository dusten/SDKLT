...
static uint32_t
bcm56960_a0_lta_bcmimm_tm_thd_ing_headroom_pool_cth_handler_component_arg[1] = {
    4,
};
...
bcm56960_a0_lta_bcmimm_tm_thd_ing_headroom_pool_cth_handler_arg = {
    .sid = TM_THD_ING_HEADROOM_POOLt,
    .values = 1,
    .value = bcm56960_a0_lta_bcmimm_tm_thd_ing_headroom_pool_cth_handler_component_arg,
    .user_data = NULL
};
...
bcm56960_a0_lta_bcmimm_tm_thd_ing_headroom_pool_cth_handler = {
    ...
    .arg      = &bcm56960_a0_lta_bcmimm_tm_thd_ing_headroom_pool_cth_handler_arg
};
