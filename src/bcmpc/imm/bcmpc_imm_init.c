...
bcmpc_imm_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT
        (bcmpc_imm_pm_register(unit));
    SHR_IF_ERR_EXIT
        (bcmpc_imm_pm_core_register(unit));
    SHR_IF_ERR_EXIT
        (bcmpc_imm_pm_lane_register(unit));
    SHR_IF_ERR_EXIT
        (bcmpc_imm_pm_tx_lane_profile_register(unit));
    SHR_IF_ERR_EXIT
        (bcmpc_imm_pm_rx_lane_profile_register(unit));
    SHR_IF_ERR_EXIT
        (bcmpc_imm_autoneg_profile_register(unit));
    SHR_IF_ERR_EXIT
        (bcmpc_imm_pfc_profile_register(unit));
    SHR_IF_ERR_EXIT
