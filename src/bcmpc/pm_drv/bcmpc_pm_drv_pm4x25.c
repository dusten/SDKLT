...
static int
pm4x25_pm_mode_validate(int unit, bcmpc_pm_mode_t *mode)
{
    int idx;
...
static int
pm4x25_speed_validate(int unit, uint32_t num_lanes, uint32_t speed)
{
...
bcmpc_pm_drv_t bcmpc_pm_drv_pm4x25 = {
    .pm_mode_validate = pm4x25_pm_mode_validate,
    .speed_validate = pm4x25_speed_validate,
