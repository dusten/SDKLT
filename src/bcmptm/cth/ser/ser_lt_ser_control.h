 ...
 */
/*!
 * \brief Register IMM callback routine for LT SER_CONTROLt.
 *
...
/*!
 * \brief Insert an entry to create LT SER_CONTROLt.
...
/*!
 * \brief Sync data from IMM to cache of LT SER_CONTROLt.
