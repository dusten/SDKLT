/*! \file ser_lt_ser_control_pt.h
 *
 * Interface functions for IMM SER_CONTROL_PT
 *
 * Get data from cache of SER_CONTROL_PT and update data to SER_CONTROL_PT
 */
/*
...
#ifndef SER_LT_SER_CONTROL_PT_H
#define SER_LT_SER_CONTROL_PT_H
 ...
 */
/*!
 * \brief Initialize cache of SER_CONTROL_PTt.
 *
...
/*!
 * \brief Free cache of SER_CONTROL_PTt.
 *
 * \param [in] unit           Logical device id.
 *
 * \retval SHR_E_NONE Success
...
/*!
 * \brief Sync SER_CONTROL_PTt data from IMM to cache.
 * Be called during Warmboot.
 *
 * \param [in] unit           Logical device id.
 *
 * \retval SHR_E_NONE Success
...
/*!
 * \brief Register IMM callback routine for LT SER_CONTROL_PTt.
 *
 * \param [in] unit           Logical device id.
 *
 *
 ...
 */
extern int
bcmptm_ser_control_pt_imm_update(int unit, bcmdrd_sid_t pt_id,
 ...
 */
extern int
bcmptm_ser_control_pt_imm_insert(int unit, bcmdrd_sid_t pt_id, int enable);

#endif /* SER_LT_SER_CONTROL_PT_H */
