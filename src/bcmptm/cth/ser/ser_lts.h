...
typedef struct lt_ser_field_info_s {
    uint32_t  lt_fid;
    uint32_t  data[BCMDRD_CONFIG_MAX_UNITS];
    uint32_t  default_val;
} bcmptm_ser_lt_field_info_t;
...
/*!
 * \brief Allocate memory space of array fields
 *
...
/*!
 * \brief Free memory space of array fields
 *
 * \param [in] unit                   Logical device id.
