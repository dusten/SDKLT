 ...
 */
/*!
 * \brief Sync data from IMM to cache of LT SER_STATSt.
...
/*!
 * \brief Get field data from IMM or cache of \ref SER_STATSt.
 *
 * \param [in] unit           Logical device id.
 * \param [in] fid_lt         field id.
 * \param [in] imm_flag   1: get data from IMM and sync IMM data to cache
 *                                   0: get data from cache.
 *
 * \retval  Field data
 */
extern uint32_t
...
/*!
*\brief Used to get value of cache of  field\ref SER_STATSt_PT_IDf of IMM LT \ref SER_STATSt.
*/
#define  BCMPTM_SER_STATS_PT_ID(_unit) \
    bcmptm_ser_stats_field_val_get(_unit, SER_STATSt_PT_IDf, 0)
