 ...
 * Defines
 */
#define REGS_ENTRY_WORDS_MAX    8
#define CTH_ALPM_DEV(u)             (cth_alpm_device_info[u])
#define CTH_ALPM_DRV(u)             (cth_alpm_driver[u])
#define CTH_ALPM_DRV_EXEC(u, fn)    (CTH_ALPM_DRV(u)->fn)
 ...
 */
typedef struct cth_alpm_control_device_info_s {
...
typedef int (*cth_alpm_device_info_init_f) (int u,
 ...
 */
extern int
bcmptm_cth_alpm_driver_register(int u, cth_alpm_driver_t *drv);
