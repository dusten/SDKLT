 ...
 * Private variables
 */
static bool cth_uft_init_warm[BCMDRD_CONFIG_MAX_UNITS];
 ...
 */
static shr_sysm_rv_t
cth_uft_sysm_init(shr_sysm_categories_t instance_category,
                  int unit,
                  void *comp_data,
                  bool warm,
                  uint32_t *blocking_component)
 ...
 */
static shr_sysm_rv_t
cth_uft_sysm_comp_config(shr_sysm_categories_t instance_category,
                         int unit,
                         void *comp_data,
                         bool warm,
                         uint32_t *blocking_component)
 ...
 */
static shr_sysm_rv_t
cth_uft_sysm_pre_config(shr_sysm_categories_t instance_category,
                        int unit,
                        void *comp_data,
                        bool warm,
                        uint32_t *blocking_component)
 ...
 */
static void
cth_uft_sysm_run(shr_sysm_categories_t instance_category,
                 int unit,
                 void *comp_data)
{
    return;
 ...
 */
static shr_sysm_rv_t
cth_uft_sysm_stop(shr_sysm_categories_t instance_category,
                  int unit,
                  void *comp_data,
                  bool graceful,
                  uint32_t *blocking_component)
...
/* Phase: shutdown */
static shr_sysm_rv_t
cth_uft_sysm_shutdown(shr_sysm_categories_t instance_category,
                      int unit,
                      void *comp_data,
                      bool warm,
                      uint32_t *blocking_component)
{
    ...
    if (!cth_uft_init_warm[unit]) { /* WB_NOT_YET_SUPPORTED */
        if (SHR_FAILURE(bcmptm_uft_cleanup(unit))) {
            return SHR_SYSM_RV_ERROR;
        }
...
bcmptm_cth_uft_start(void)
{
    ...
    sal_memset(&funcs, 0, sizeof(funcs));
    funcs.init = cth_uft_sysm_init;
    funcs.comp_config = cth_uft_sysm_comp_config;
    funcs.pre_config = cth_uft_sysm_pre_config;
    funcs.run = cth_uft_sysm_run;
    funcs.stop = cth_uft_sysm_stop;
    funcs.shutdown = cth_uft_sysm_shutdown;
    SHR_IF_ERR_EXIT(
        shr_sysm_register(BCMMGMT_UFT_COMP_ID,
                          SHR_SYSM_CAT_UNIT,
                          &funcs,
