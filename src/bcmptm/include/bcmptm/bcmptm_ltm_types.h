...
/*!
 * \brief Retrieve the callback for incrementing LTM statistics.
 *
 ...
 * implementation to update these statistics. This function retrieves
 * the callback registered for a given unit.
 *
 * \param [in] unit Logical device id.
 *
 * \retval  Callback function to increment LT statistics.
 */
extern bcmptm_lt_stats_increment_cb
