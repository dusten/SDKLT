/*! \file bcmtm_rate_encoding_internal.h
 *
 * TM rate encoding functions.
 */
/*
...
#ifndef BCMTM_RATE_ENCODING_INTERNAL_H
#define BCMTM_RATE_ENCODING_INTERNAL_H

#include <shr/shr_types.h>
#include <bcmtm/bcmtm_types.h>

extern int
bcmtm_rate_to_bucket_set(int unit, int port,
