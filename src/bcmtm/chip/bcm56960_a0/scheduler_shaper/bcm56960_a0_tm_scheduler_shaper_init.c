/*! \file bcm56960_a0_tm_scheduler_shaper_init.c
 *
...
bcm56960_a0_tm_shaper_config_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT
        (bcmtm_field_set(unit, sid, TICK_MODE_SELf, &ltmbuf, &fval));
    SHR_IF_ERR_EXIT
        (bcmtm_pt_indexed_write(unit, sid, ltid, (void *)&pt_dyn_info, &fval));
exit:
    SHR_FUNC_EXIT();
...
bcm56960_a0_tm_scheduler_shaper_chip_init(int unit)
{
    ...
    /* shaper config */
    SHR_IF_ERR_EXIT(bcm56960_a0_tm_shaper_config_init(unit));

    /* initialize device type function pointers. */
    SHR_IF_ERR_EXIT(bcm56960_a0_tm_shaper_fn_ptrs_init(unit));
exit:
    SHR_FUNC_EXIT();
}
