/*! \file bcm56960_a0_tm_imm_thd_ucq.c
 *
 ...
 */
static int
bcm56960_a0_tm_ucq_reset(int unit,
        bcmltd_sid_t ltid,
        const bcmltd_field_t *key)
{
    bcmdrd_sid_t sid;
    bcmdrd_sid_t resume_sid[] = {MMU_THDU_RESUME_QUEUE_MMU_XPE0_EPIPE0m,
    ...
    /* TM_THD_UC_Qt_PORT_IDf */
    ltfid = TM_THD_UC_Qt_PORT_IDf;
    SHR_IF_ERR_EXIT
        (bcmtm_fval_get_from_field_array(unit, ltfid, key, (uint64_t *)&lport));

    /* TM_THD_UC_Qt_TM_THD_UC_Q_IDf */
    ltfid = TM_THD_UC_Qt_TM_THD_UC_Q_IDf;
    SHR_IF_ERR_EXIT
        (bcmtm_fval_get_from_field_array(unit, ltfid, key, (uint64_t *)&ucq_id));
 ...
 */
static int
bcm56960_a0_tm_ucq_set(int unit,
        bcmltd_sid_t ltid,
        const bcmltd_field_t *key,
        ...
        bcmltd_fields_t *output_fields)
{
    ...
    while(cur_data) {
        ...
        switch(cur_data->id) {
            case TM_THD_UC_Qt_MIN_GUARANTEE_CELLSf:
                ...
                break;
            case TM_THD_UC_Qt_USE_DYNAMIC_SHARED_LIMITSf:
                sid = MMU_THDU_CONFIG_QUEUEm;
            ...
            case TM_THD_UC_Qt_SHARED_LIMIT_DYNAMICf:
                ...
                break;
            case TM_THD_UC_Qt_USE_COLOR_SPECIFIC_DYNAMIC_LIMITSf:
                sid = MMU_THDU_CONFIG_QUEUEm;
            ...
            case TM_THD_UC_Qt_RESET_OFFSET_CELLSf:
                ...
                fval = fval / 8;
                break;
            case TM_THD_UC_Qt_RESET_FLOOR_CELLSf:
                sid = resume_sid[pipe];
                fid = QDRP_RESETf;
                fval = fval / 8;
                break;
            case TM_THD_UC_Qt_RESET_OFFSET_YELLOW_CELLSf:
                ...
                fval = fval / 8;
                break;
            case TM_THD_UC_Qt_RESET_FLOOR_YELLOW_CELLSf:
                sid = resume_sid[pipe];
                fid = QYEL_RESETf;
                fval = fval / 8;
                break;
            case TM_THD_UC_Qt_RESET_OFFSET_RED_CELLSf:
                ...
                fval = fval / 8;
                break;
            case TM_THD_UC_Qt_RESET_FLOOR_RED_CELLSf:
                sid = resume_sid[pipe];
                fid = QRED_RESETf;
                fval = fval / 8;
                break;
    ...
    opcode = 0;
op_stage:
    ltfid = TM_THD_UC_Qt_OPERATIONAL_STATEf;
...
/*!
 * \brief TM_THD_UC_Qt callback function for staging.
 *
 * Handle TM_THD_UC_Q IMM table change events.
 *
 * \param [in] unit Unit number.
 ...
 */
static int
bcm56960_a0_tm_ucq_stage(int unit,
        bcmltd_sid_t ltid,
        uint32_t trans_id,
        ...
        bcmltd_fields_t *output_fields)
{
    ...
    switch(event_reason) {
        ...
        case BCMIMM_ENTRY_INSERT:
            ...
            SHR_IF_ERR_EXIT
                (bcm56960_a0_tm_ucq_set(unit, ltid, key,
                                                  data, output_fields));
            break;
        case BCMIMM_ENTRY_DELETE:
            SHR_IF_ERR_EXIT
                (bcm56960_a0_tm_ucq_reset(unit, ltid, key));
            break;
        default:
            break;
    }
...
{
    /*! Inmemory callback functions for TM_THD_UC_Qt logical table. */
    static bcmimm_lt_cb_t bcmtm_ucq_imm_cb = {
        /*! Staging function. */
        .stage = bcm56960_a0_tm_ucq_stage,
    };
    int rv;
