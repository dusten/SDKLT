/*! \file bcm56960_a0_tm_imm_thd_egr_sp.c
 *
 * TM egress service pool threshold configuration for 56960_a0.
 */
/*
 ...
 */
static int
bcm56960_a0_tm_egr_sp_reset(int unit,
        bcmltd_sid_t ltid,
        const bcmltd_field_t *key)
{
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    bcmdrd_fid_t global_pool_color_limit[] = {
    ...
    /* TM_THD_EGR_SERVICE_POOLt_TM_THD_SERVICE_POOL_IDf */
    ltfid = TM_THD_EGR_SERVICE_POOLt_TM_THD_SERVICE_POOL_IDf;
    SHR_IF_ERR_EXIT
        (bcmtm_fval_get_from_field_array(unit, ltfid, key, (uint64_t *)&sp_id));

    /* TM_THD_EGR_SERVICE_POOLt_USE_COLOR_SPECIFIC_LIMITSf */
    sid = MMU_THDM_DB_DEVICE_THR_CONFIGr;
    fid = global_pool_color_limit[sp_id];
    ...
    ltmbuf = 0;
    /* TM_THD_EGR_SERVICE_POOLt_SHARED_LIMIT_CELLSf */
    ...
    /* TM_THD_EGR_SERVICE_POOLt_SHARED_RESUME_LIMIT_CELLSf */
    ...
    /* TM_THD_EGR_SERVICE_POOLt_YELLOW_SHARED_LIMIT_CELLSf */
    ...
    /* TM_THD_EGR_SERVICE_POOLt_YELLOW_SHARED_RESUME_LIMIT_CELLSf */
    ...
    /* TM_THD_EGR_SERVICE_POOLt_RED_SHARED_LIMIT_CELLSf */
    ...
    /* TM_THD_EGR_SERVICE_POOLt_RED_SHARED_RESUME_LIMIT_CELLSf */
 ...
 */
static int
bcm56960_a0_tm_egr_sp_set(int unit,
        bcmltd_sid_t ltid,
        const bcmltd_field_t *key,
        ...
        bcmltd_fields_t *output_fields)
{
    ...
    while(cur_data) {
        ltmbuf = 0;
        switch(cur_data->id) {
            case TM_THD_EGR_SERVICE_POOLt_USE_COLOR_SPECIFIC_LIMITSf:
                sid = MMU_THDM_DB_DEVICE_THR_CONFIGr;
                fid = global_pool_color_limit[sp_id];
                BCMTM_PT_DYN_INFO(pt_dyn_info, 0, 0);
                SHR_IF_ERR_EXIT
...
/*!
 * \brief TM_THD_EGR_SERVICE_POOL callback function for staging.
 *
 * Handle TM_THD_EGR_SERVICE_POOL IMM table change events.
 *
 * \param [in] unit Unit number.
 ...
 */
static int
bcm56960_a0_tm_egr_sp_stage(int unit,
        bcmltd_sid_t ltid,
        uint32_t trans_id,
        ...
        bcmltd_fields_t *output_fields)
{
    ...
    switch(event_reason) {
        ...
        case BCMIMM_ENTRY_INSERT:
            ...
            SHR_IF_ERR_EXIT
                (bcm56960_a0_tm_egr_sp_set(unit, ltid, key,
                                                  data, output_fields));
            break;
        case BCMIMM_ENTRY_DELETE:
            SHR_IF_ERR_EXIT
                (bcm56960_a0_tm_egr_sp_reset(unit, ltid, key));
            break;
        default:
            break;
    }
...
{
    /*! Inmemory callback functions for TM_THD_EGR_SERVICE_POOL table.*/
    bcmimm_lt_cb_t bcmtm_egr_sp_imm_cb = {
        /*! Staging function. */
        .stage = bcm56960_a0_tm_egr_sp_stage,
    };
    const bcmlrd_map_t *map = NULL;
    int rv;

    SHR_FUNC_ENTER(unit);
    /*! Registers callback functions for egress service pool. */
    rv = bcmlrd_map_get(unit, TM_THD_EGR_SERVICE_POOLt, &map);
    if (SHR_SUCCESS(rv) && map) {
        SHR_IF_ERR_EXIT(bcmimm_lt_event_reg(unit,
                                            TM_THD_EGR_SERVICE_POOLt,
