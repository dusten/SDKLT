/*! \file tomahawk_ep_flexport.h
 *
 *  EP flexport related structures and function prototypes.
 */
/*
...
#ifndef TOMAHAWK_EP_FLEXPORT_H
#define TOMAHAWK_EP_FLEXPORT_H

#if 0
/* Transmit Start Count */
typedef struct soc_th_edb_xmit_start_count_s {
    /* NOTE: DON'T ALTER FIELD ORDER */
    uint8 line_rate;       /* Line-rate */
    uint8 oversub_3_2;     /* 3:2 Oversub */
    uint8 oversub_2_1;     /* 2:1 Oversub */
} soc_th_edb_xmit_start_count_t;
#endif
...
typedef struct soc_th_ep_cfg_s {
    /* NOTE: DON'T ALTER FIELD ORDER */
    int speed;
    int egr_mmu_credit;                                  /* Baseline */
    int egr_mmu_credit_max_freq;                         /* PFC Optimized */
    soc_th_edb_xmit_start_count_t xmit_cnt_l2_latency;  /* L2 Latency Mode */
    soc_th_edb_xmit_start_count_t xmit_cnt_l3_latency;  /* L3, Full Latency Modes */
    soc_th_edb_xmit_start_count_t xmit_cnt_full_latency;/* L3, Full Latency Modes */
} soc_th_ep_core_cfg_t;
