/*! \file bcmtm_wred_pipe_sp_xfrm.c
 *
 ...
 */
int
bcmtm_wred_pipe_sp_idx_transform(int unit,
...
int
bcmtm_wred_pipe_sp_field_transform(int unit,
                                 const bcmltd_fields_t *in,
                                 bcmltd_fields_t *out,
                                 const bcmltd_transform_arg_t *arg)
{
    ...
    while (count  < in->count) {
        switch(in->field[count]->id) {
            case TM_WRED_PIPE_SERVICE_POOLt_DRAIN_TRACKf:
                id = arg->rfield[0];
                break;
            ...
            case TM_WRED_PIPE_SERVICE_POOLt_WREDf:
                id = arg->rfield[2];
                break;
            case TM_WRED_PIPE_SERVICE_POOLt_TM_WRED_TIMER_PROFILE_IDf:
                id = arg->rfield[3];
                break;
...
int
bcmtm_wred_pipe_sp_field_rev_transform(int unit,
                                 const bcmltd_fields_t *in,
                                 bcmltd_fields_t *out,
                                 const bcmltd_transform_arg_t *arg)
{
