...
static const bcmltd_field_rep_t bcmltd_trunk_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_lb_mode,  /* LB_MODE */
    ...
    {
        .name  = bcmltd_strpool_uc_rtag,  /* UC_RTAG */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_uc_max_members,  /* UC_MAX_MEMBERS */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_uc_member_cnt,  /* UC_MEMBER_CNT */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_uc_member_modid,  /* UC_MEMBER_MODID */
        .flags = 0,
        .width = 8,
        .depth = 256,
    ...
    {
        .name  = bcmltd_strpool_uc_member_modport,  /* UC_MEMBER_MODPORT */
        .flags = 0,
        .width = 8,
        .depth = 256,
    ...
    {
        .name  = bcmltd_strpool_uc_agm_id,  /* UC_AGM_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_nonuc_member_cnt,  /* NONUC_MEMBER_CNT */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_nonuc_member_modid,  /* NONUC_MEMBER_MODID */
        .flags = 0,
        .width = 8,
        .depth = 256,
    ...
    {
        .name  = bcmltd_strpool_nonuc_member_modport,  /* NONUC_MEMBER_MODPORT */
        .flags = 0,
        .width = 8,
        .depth = 256,
...
const bcmltd_table_rep_t bcmltd_trunk_t = {
    .name = bcmltd_strpool_trunk, /* TRUNK */
    .flags = 0,
    .fields = 11,
