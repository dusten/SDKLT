...
static const bcmltd_field_rep_t bcmltd_lb_hash_l2_fields_selection_t_fields[] = {
    {
        ...
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for L2 packets for Hash 0/1.",
    },
    {
    ...
    {
        .name  = bcmltd_strpool_hash0_eth_type,  /* HASH0_ETH_TYPE */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for L2 packets for Hash 0/1.",
    ...
    {
        .name  = bcmltd_strpool_hash0_mac_da_lo,  /* HASH0_MAC_DA_LO */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for L2 packets for Hash 0/1.",
    ...
    {
        .name  = bcmltd_strpool_hash0_mac_da_med,  /* HASH0_MAC_DA_MED */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for L2 packets for Hash 0/1.",
    ...
    {
        .name  = bcmltd_strpool_hash0_mac_da_hi,  /* HASH0_MAC_DA_HI */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for L2 packets for Hash 0/1.",
    ...
    {
        .name  = bcmltd_strpool_hash0_mac_sa_lo,  /* HASH0_MAC_SA_LO */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for L2 packets for Hash 0/1.",
    ...
    {
        .name  = bcmltd_strpool_hash0_mac_sa_med,  /* HASH0_MAC_SA_MED */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for L2 packets for Hash 0/1.",
    ...
    {
        .name  = bcmltd_strpool_hash0_mac_sa_hi,  /* HASH0_MAC_SA_HI */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for L2 packets for Hash 0/1.",
    ...
    {
        .name  = bcmltd_strpool_hash1_eth_type,  /* HASH1_ETH_TYPE */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_mac_da_lo,  /* HASH1_MAC_DA_LO */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_mac_da_med,  /* HASH1_MAC_DA_MED */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_mac_da_hi,  /* HASH1_MAC_DA_HI */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_mac_sa_lo,  /* HASH1_MAC_SA_LO */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_mac_sa_med,  /* HASH1_MAC_SA_MED */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_mac_sa_hi,  /* HASH1_MAC_SA_HI */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
...
const bcmltd_table_rep_t bcmltd_lb_hash_l2_fields_selection_t = {
    .name = bcmltd_strpool_lb_hash_l2_fields_selection, /* LB_HASH_L2_FIELDS_SELECTION */
    .flags = 0,
    .fields = 30,
