...
static const bcmltd_field_rep_t bcmltd_lb_hash_algorithm_t_fields[] = {
    {
        .name  = bcmltd_strpool_hash0_instance0_alg,  /* HASH0_INSTANCE0_ALG */
    ...
    {
        .name  = bcmltd_strpool_hash0_instance1_alg,  /* HASH0_INSTANCE1_ALG */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_hash1_instance0_alg,  /* HASH1_INSTANCE0_ALG */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_hash1_instance1_alg,  /* HASH1_INSTANCE1_ALG */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_macro_flow_hash_alg,  /* MACRO_FLOW_HASH_ALG */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
        .desc = "Algorithm to be used for generation of RTAG7 Hash Macro Flow\n Identifier.\n",
    },
};
const bcmltd_table_rep_t bcmltd_lb_hash_algorithm_t = {
    .name = bcmltd_strpool_lb_hash_algorithm, /* LB_HASH_ALGORITHM */
    .flags = 0,
    .fields = 5,
