...
static const bcmltd_field_rep_t bcmltd_port_vlan_xlate_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_ing_xlate,  /* ING_XLATE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_xlate,  /* EGR_XLATE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ing_xlate_tbl_sel_first_lookup,  /* ING_XLATE_TBL_SEL_FIRST_LOOKUP */
    ...
    {
        .name  = bcmltd_strpool_ing_xlate_tbl_sel_second_lookup,  /* ING_XLATE_TBL_SEL_SECOND_LOOKUP */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ing_miss_action,  /* ING_MISS_ACTION */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_xlate_miss_drop,  /* EGR_XLATE_MISS_DROP */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_xlate_miss_ut_drop,  /* EGR_XLATE_MISS_UT_DROP */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_xlate_miss_untag,  /* EGR_XLATE_MISS_UNTAG */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_opri_mapped,  /* OPRI_MAPPED */
        .flags = 0,
        .width = 3,
        .depth = 8,
    ...
    {
        .name  = bcmltd_strpool_ocfi_mapped,  /* OCFI_MAPPED */
        .flags = 0,
        .width = 1,
        .depth = 2,
    ...
    {
        .name  = bcmltd_strpool_ipri_mapped,  /* IPRI_MAPPED */
        .flags = 0,
        .width = 3,
        .depth = 8,
    ...
    {
        .name  = bcmltd_strpool_icfi_mapped,  /* ICFI_MAPPED */
        .flags = 0,
        .width = 1,
        .depth = 2,
...
const bcmltd_table_rep_t bcmltd_port_vlan_xlate_t = {
    .name = bcmltd_strpool_port_vlan_xlate, /* PORT_VLAN_XLATE */
    .flags = 0,
    .fields = 14,
