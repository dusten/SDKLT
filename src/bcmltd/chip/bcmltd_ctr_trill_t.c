...
static const bcmltd_field_rep_t bcmltd_ctr_trill_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_ing_trill_rx_pkts,  /* ING_TRILL_RX_PKTS */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_trill_tx_pkts,  /* EGR_TRILL_TX_PKTS */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ing_trill_rx_access_port_trill_pkts_discarded,  /* ING_TRILL_RX_ACCESS_PORT_TRILL_PKTS_DISCARDED */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_trill_tx_access_port_trill_pkts_discarded,  /* EGR_TRILL_TX_ACCESS_PORT_TRILL_PKTS_DISCARDED */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ing_trill_rx_network_port_non_trill_pkts_discarded,  /* ING_TRILL_RX_NETWORK_PORT_NON_TRILL_PKTS_DISCARDED */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_trill_tx_network_port_non_trill_pkts_discarded,  /* EGR_TRILL_TX_NETWORK_PORT_NON_TRILL_PKTS_DISCARDED */
        .flags = 0,
        .width = 64,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ctr_trill_t = {
    .name = bcmltd_strpool_ctr_trill, /* CTR_TRILL */
    .flags = 0,
    .fields = 7,
