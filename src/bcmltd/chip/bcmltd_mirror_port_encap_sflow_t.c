...
static const bcmltd_field_rep_t bcmltd_mirror_port_encap_sflow_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_sample_ing,  /* SAMPLE_ING */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_egr,  /* SAMPLE_EGR */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_ing_flex,  /* SAMPLE_ING_FLEX */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_ing_cpu,  /* SAMPLE_ING_CPU */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_ing_mirror_instance,  /* SAMPLE_ING_MIRROR_INSTANCE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_ing_flex_cpu,  /* SAMPLE_ING_FLEX_CPU */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_ing_flex_mirror_instance,  /* SAMPLE_ING_FLEX_MIRROR_INSTANCE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_ing_rate,  /* SAMPLE_ING_RATE */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_egr_rate,  /* SAMPLE_EGR_RATE */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sample_ing_flex_rate,  /* SAMPLE_ING_FLEX_RATE */
        .flags = 0,
        .width = 32,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_mirror_port_encap_sflow_t = {
    .name = bcmltd_strpool_mirror_port_encap_sflow, /* MIRROR_PORT_ENCAP_SFLOW */
    .flags = 0,
    .fields = 11,
    .field = bcmltd_mirror_port_encap_sflow_t_fields,
    .desc = "The MIRROR_PORT_ENCAP_SFLOW logical table is used to specify\n per-port sFlow encapsulation sample configuration.\n",
};
