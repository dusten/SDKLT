...
static const bcmltd_field_rep_t bcmltd_tm_shaper_config_t_fields[] = {
    {
        .name  = bcmltd_strpool_refresh_time,  /* REFRESH_TIME */
    ...
    {
        .name  = bcmltd_strpool_itu_mode,  /* ITU_MODE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_shaper,  /* SHAPER */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_shaper_config_t = {
    .name = bcmltd_strpool_tm_shaper_config, /* TM_SHAPER_CONFIG */
