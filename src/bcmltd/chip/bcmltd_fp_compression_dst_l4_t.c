...
static const bcmltd_field_rep_t bcmltd_fp_compression_dst_l4_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_fp_compression_dst_l4_id,  /* FP_COMPRESSION_DST_L4_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_dst_l4_type,  /* DST_L4_TYPE */
    ...
    {
        .name  = bcmltd_strpool_dst_l4,  /* DST_L4 */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_compressed_dst_l4,  /* COMPRESSED_DST_L4 */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_fp_compression_dst_l4_t = {
    .name = bcmltd_strpool_fp_compression_dst_l4, /* FP_COMPRESSION_DST_L4 */
    .flags = 0,
    .fields = 5,
    .field = bcmltd_fp_compression_dst_l4_t_fields,
    .desc = "Logical Table to create compression map for third and fourth bytes in\n L4 header of IP packet or RX ID in FCoE Packet. In case of IP packet, field\n could be either L4 destination port or ICMP type. Each entry in this LT\n will assign one compressed value to one original value.\n It is programming requirement to not have two different entries with\n same match value(DST_L4) and entry type(DST_L4_TYPE)\n",
};
