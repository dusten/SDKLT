...
static const bcmltd_field_rep_t bcmltd_tm_oobfc_port_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_ingress,  /* INGRESS */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_cng_report,  /* CNG_REPORT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_tm_oobfc_q_map_profile_id,  /* TM_OOBFC_Q_MAP_PROFILE_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_oobfc_port_t = {
    .name = bcmltd_strpool_tm_oobfc_port, /* TM_OOBFC_PORT */
    .flags = 0,
    .fields = 5,
