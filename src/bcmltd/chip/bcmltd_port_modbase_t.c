...
static const bcmltd_field_rep_t bcmltd_port_modbase_t_fields[] = {
    ...
    },
    {
        ...
        .width = 16,
        .depth = 0,
        .desc = "PORT_SYSTEM logical table index.",
    },
};
const bcmltd_table_rep_t bcmltd_port_modbase_t = {
    .name = bcmltd_strpool_port_modbase, /* PORT_MODBASE */
    .flags = 0,
    .fields = 2,
    .field = bcmltd_port_modbase_t_fields,
    .desc = "The PORT_MODBASE table specifies PORT_SYSTEM_ID in a stacking system.",
};
