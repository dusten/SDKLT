...
static const bcmltd_field_rep_t bcmltd_ecn_ip_to_mpls_exp_non_responsive_t_fields[] = {
    {
        .name  = bcmltd_strpool_ecn_ip_to_mpls_exp_non_responsive_id,  /* ECN_IP_TO_MPLS_EXP_NON_RESPONSIVE_ID */
    ...
    {
        .name  = bcmltd_strpool_change_exp,  /* CHANGE_EXP */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_new_exp,  /* NEW_EXP */
        .flags = 0,
        .width = 3,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ecn_ip_to_mpls_exp_non_responsive_t = {
    .name = bcmltd_strpool_ecn_ip_to_mpls_exp_non_responsive, /* ECN_IP_TO_MPLS_EXP_NON_RESPONSIVE */
    .flags = 0,
    .fields = 7,
