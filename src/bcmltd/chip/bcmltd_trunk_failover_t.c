...
static const bcmltd_field_rep_t bcmltd_trunk_failover_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_failover_cnt,  /* FAILOVER_CNT */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_failover_modid,  /* FAILOVER_MODID */
        .flags = 0,
        .width = 8,
        .depth = 8,
    ...
    {
        .name  = bcmltd_strpool_failover_modport,  /* FAILOVER_MODPORT */
        .flags = 0,
        .width = 8,
        .depth = 8,
...
const bcmltd_table_rep_t bcmltd_trunk_failover_t = {
    .name = bcmltd_strpool_trunk_failover, /* TRUNK_FAILOVER */
    .flags = 0,
    .fields = 5,
