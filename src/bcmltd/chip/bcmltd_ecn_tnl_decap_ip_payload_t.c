...
static const bcmltd_field_rep_t bcmltd_ecn_tnl_decap_ip_payload_t_fields[] = {
    {
        .name  = bcmltd_strpool_ecn_tnl_decap_ip_payload_id,  /* ECN_TNL_DECAP_IP_PAYLOAD_ID */
    ...
    {
        .name  = bcmltd_strpool_tnl_ecn,  /* TNL_ECN */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_payload_ecn,  /* PAYLOAD_ECN */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_change_payload_ecn,  /* CHANGE_PAYLOAD_ECN */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_new_payload_ecn,  /* NEW_PAYLOAD_ECN */
        .flags = 0,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ctr_ecn,  /* CTR_ECN */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ecn_tnl_decap_ip_payload_t = {
    .name = bcmltd_strpool_ecn_tnl_decap_ip_payload, /* ECN_TNL_DECAP_IP_PAYLOAD */
    .flags = 0,
    .fields = 8,
