...
static const bcmltd_field_rep_t bcmltd_l3_ip_option_control_profile_t_fields[] = {
    {
        .name  = bcmltd_strpool_l3_ip_option_control_profile_id,  /* L3_IP_OPTION_CONTROL_PROFILE_ID */
    ...
    {
        .name  = bcmltd_strpool_pkt_ip_option_number,  /* PKT_IP_OPTION_NUMBER */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_l3_ip_option_control_profile_t = {
    .name = bcmltd_strpool_l3_ip_option_control_profile, /* L3_IP_OPTION_CONTROL_PROFILE */
    .flags = 0,
    .fields = 4,
