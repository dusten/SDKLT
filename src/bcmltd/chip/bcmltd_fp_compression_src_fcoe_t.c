...
static const bcmltd_field_rep_t bcmltd_fp_compression_src_fcoe_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_src_fcoe_identifier,  /* SRC_FCOE_IDENTIFIER */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_src_fcoe_identifier_mask,  /* SRC_FCOE_IDENTIFIER_MASK */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_compressed_src_fcoe_identifier,  /* COMPRESSED_SRC_FCOE_IDENTIFIER */
        .flags = 0,
        .width = 64,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_fp_compression_src_fcoe_t = {
    .name = bcmltd_strpool_fp_compression_src_fcoe, /* FP_COMPRESSION_SRC_FCOE */
    .flags = BCMLTD_TABLE_F_TYPE_TCAM,
    .fields = 6,
    .field = bcmltd_fp_compression_src_fcoe_t_fields,
    .desc = "Logical Table to create compression map for source FCoE identifier.\n Compressed value can be assigned to a single or range of source FCoE\n identifier. Compressed value along with original source FCoE identifier are\n available in FP to match. Source identifier is a field in FCoE Header.\n",
};
