...
static const bcmltd_field_rep_t bcmltd_meter_storm_control_enable_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_byte_mode,  /* BYTE_MODE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_bcast,  /* BCAST */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_known_l2mc,  /* KNOWN_L2MC */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_unknown_l2mc,  /* UNKNOWN_L2MC */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_known_ipmc,  /* KNOWN_IPMC */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_unknown_ipmc,  /* UNKNOWN_IPMC */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_dlfbc,  /* DLFBC */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_meter_storm_control_enable_t = {
    .name = bcmltd_strpool_meter_storm_control_enable, /* METER_STORM_CONTROL_ENABLE */
    .flags = 0,
    .fields = 8,
    .field = bcmltd_meter_storm_control_enable_t_fields,
    .desc = "Enable per-port metering for specific packet types.\n",
};
