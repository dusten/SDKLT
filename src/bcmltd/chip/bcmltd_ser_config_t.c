...
static const bcmltd_field_rep_t bcmltd_ser_config_t_fields[] = {
    {
        .name  = bcmltd_strpool_ser_enable,  /* SER_ENABLE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_message_q_depth,  /* MESSAGE_Q_DEPTH */
        .flags = 0,
        .width = 16,
        .depth = 0,
        .desc = "Depth of SER message queue. Increase the value of\n this field in order to enlarge SER message queue,\n and then can save more SER message.\n",
    },
};
const bcmltd_table_rep_t bcmltd_ser_config_t = {
    .name = bcmltd_strpool_ser_config, /* SER_CONFIG */
