...
static const bcmltd_field_rep_t bcmltd_port_egr_mirror_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_egr_port_id,  /* EGR_PORT_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
        .desc = "Egress port ID",
    ...
    {
        .name  = bcmltd_strpool_mirror_enable,  /* MIRROR_ENABLE */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable mirror.",
...
const bcmltd_table_rep_t bcmltd_port_egr_mirror_t = {
    .name = bcmltd_strpool_port_egr_mirror, /* PORT_EGR_MIRROR */
    .flags = 0,
    .fields = 4,
    .field = bcmltd_port_egr_mirror_t_fields,
    .desc = "The PORT_EGR_MIRROR logical table is used to enable or disable egress\n mirroring on specified ingress port, egress port and mirror instance.\n",
};
