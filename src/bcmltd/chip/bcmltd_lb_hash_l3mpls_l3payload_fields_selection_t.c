 ...
 * This file is auto-generated by fltg from INTERNAL/fltg/xgs/lb_hash/LB_HASH_L3MPLS_L3PAYLOAD_FIELDS_SELECTION.tbl.ltl
...
static const bcmltd_field_rep_t bcmltd_lb_hash_l3mpls_l3payload_fields_selection_t_fields[] = {
    {
        .name  = bcmltd_strpool_hash0_dst_modid,  /* HASH0_DST_MODID */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for MPLS terminated packets with\n L3 payloads for Hash 0\n",
    },
    {
        .name  = bcmltd_strpool_hash0_flow_id_lo,  /* HASH0_FLOW_ID_LO */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for MPLS terminated packets with\n L3 payloads for Hash 0\n",
    ...
    {
        .name  = bcmltd_strpool_hash0_flow_id_hi,  /* HASH0_FLOW_ID_HI */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for MPLS terminated packets with\n L3 payloads for Hash 0\n",
    ...
    {
        .name  = bcmltd_strpool_hash0_next_header,  /* HASH0_NEXT_HEADER */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for MPLS terminated packets with\n L3 payloads for Hash 0\n",
    ...
    {
        .name  = bcmltd_strpool_hash0_tunnel_vid,  /* HASH0_TUNNEL_VID */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Hash field selection for MPLS terminated packets with\n L3 payloads for Hash 0\n",
    ...
    {
        .name  = bcmltd_strpool_hash1_flow_id_lo,  /* HASH1_FLOW_ID_LO */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_flow_id_hi,  /* HASH1_FLOW_ID_HI */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_next_header,  /* HASH1_NEXT_HEADER */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_hash1_tunnel_vid,  /* HASH1_TUNNEL_VID */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "",
...
const bcmltd_table_rep_t bcmltd_lb_hash_l3mpls_l3payload_fields_selection_t = {
    .name = bcmltd_strpool_lb_hash_l3mpls_l3payload_fields_selection, /* LB_HASH_L3MPLS_L3PAYLOAD_FIELDS_SELECTION */
    .flags = 0,
    .fields = 30,
    .field = bcmltd_lb_hash_l3mpls_l3payload_fields_selection_t_fields,
