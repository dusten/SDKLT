...
static const bcmltd_field_rep_t bcmltd_fp_em_entry_t_fields[] = {
    {
        .name  = bcmltd_strpool_fp_em_entry_id,  /* FP_EM_ENTRY_ID */
    ...
    {
        .name  = bcmltd_strpool_fp_em_ctr_id,  /* FP_EM_CTR_ID */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_meter_fp_em_template_id,  /* METER_FP_EM_TEMPLATE_ID */
        .flags = 0,
        .width = 16,
        .depth = 0,
        .desc = "Associated Meter ID from METER_FP_ING_TEMPLATE LT.",
    },
};
const bcmltd_table_rep_t bcmltd_fp_em_entry_t = {
    .name = bcmltd_strpool_fp_em_entry, /* FP_EM_ENTRY */
    .flags = 0,
    .fields = 7,
    .field = bcmltd_fp_em_entry_t_fields,
    .desc = "Logical Table to associate Rule Id, Action Id, Counter Id and Meter Id\n to the entries in the Group. Operations on this logical table will\n provision the device EM logic, if sufficient resources are available.\n",
};
