...
static const bcmltd_field_rep_t bcmltd_mirror_egr_member_t_fields[] = {
    {
        ...
        .width = 8,
        .depth = 0,
        .desc = "Mirror instance to compute index into the\n MIRROR_EGR_INSTANCE table.\n",
    },
    {
        .name  = bcmltd_strpool_mirror_member_id,  /* MIRROR_MEMBER_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_mirror_egr_member_t = {
    .name = bcmltd_strpool_mirror_egr_member, /* MIRROR_EGR_MEMBER */
    .flags = 0,
    .fields = 6,
    .field = bcmltd_mirror_egr_member_t_fields,
    .desc = "The MIRROR_EGR_MEMBER logical table is used to specify\n the egress mirror destination member configuration.\n",
};
