...
static const bcmltd_field_rep_t bcmltd_phb_egr_mpls_int_pri_to_l2_otag_t_fields[] = {
    {
        .name  = bcmltd_strpool_phb_egr_mpls_int_pri_to_l2_otag_id,  /* PHB_EGR_MPLS_INT_PRI_TO_L2_OTAG_ID */
...
const bcmltd_table_rep_t bcmltd_phb_egr_mpls_int_pri_to_l2_otag_t = {
    .name = bcmltd_strpool_phb_egr_mpls_int_pri_to_l2_otag, /* PHB_EGR_MPLS_INT_PRI_TO_L2_OTAG */
    .flags = 0,
    .fields = 5,
