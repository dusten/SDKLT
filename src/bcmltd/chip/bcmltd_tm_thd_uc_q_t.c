...
static const bcmltd_field_rep_t bcmltd_tm_thd_uc_q_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_tm_thd_uc_q_id,  /* TM_THD_UC_Q_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_min_guarantee_cells,  /* MIN_GUARANTEE_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_use_dynamic_shared_limits,  /* USE_DYNAMIC_SHARED_LIMITS */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_shared_limit_cells_static,  /* SHARED_LIMIT_CELLS_STATIC */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_shared_limit_dynamic,  /* SHARED_LIMIT_DYNAMIC */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_reset_offset_cells,  /* RESET_OFFSET_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_reset_floor_cells,  /* RESET_FLOOR_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_use_color_specific_dynamic_limits,  /* USE_COLOR_SPECIFIC_DYNAMIC_LIMITS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_yellow_limit_cells_static,  /* YELLOW_LIMIT_CELLS_STATIC */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_yellow_limit_dynamic,  /* YELLOW_LIMIT_DYNAMIC */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Shared buffer dynamic limit for yellow packets. Valid only\n USE_DYNAMIC_SHARED_LIMITS is enabled.\n",
    },
    {
        .name  = bcmltd_strpool_red_limit_cells_static,  /* RED_LIMIT_CELLS_STATIC */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Shared buffer static limits for red packets. Valid only if\n USE_DYNAMIC_SHARED_LIMITS is disabled.\n",
    },
    {
        .name  = bcmltd_strpool_red_limit_dynamic,  /* RED_LIMIT_DYNAMIC */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Shared buffer dynamic limits for red packets. Valid only if\n USE_DYNAMIC_SHARED_LIMITS is disabled.\n",
    },
    {
        .name  = bcmltd_strpool_reset_offset_yellow_cells,  /* RESET_OFFSET_YELLOW_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_reset_floor_yellow_cells,  /* RESET_FLOOR_YELLOW_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_reset_offset_red_cells,  /* RESET_OFFSET_RED_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_reset_floor_red_cells,  /* RESET_FLOOR_RED_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_thd_uc_q_t = {
    .name = bcmltd_strpool_tm_thd_uc_q, /* TM_THD_UC_Q */
    .flags = 0,
    .fields = 18,
