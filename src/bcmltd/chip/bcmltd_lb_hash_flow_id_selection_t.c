...
static const bcmltd_field_rep_t bcmltd_lb_hash_flow_id_selection_t_fields[] = {
    {
        .name  = bcmltd_strpool_use_most_significant_byte_as_flow_id,  /* USE_MOST_SIGNIFICANT_BYTE_AS_FLOW_ID */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_lb_hash_flow_id_selection_t = {
    .name = bcmltd_strpool_lb_hash_flow_id_selection, /* LB_HASH_FLOW_ID_SELECTION */
    .flags = 0,
    .fields = 1,
