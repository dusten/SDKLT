...
static const bcmltd_field_rep_t bcmltd_tm_bst_service_pool_thd_t_fields[] = {
    {
        .name  = bcmltd_strpool_tm_bst_service_pool_thd_id,  /* TM_BST_SERVICE_POOL_THD_ID */
    ...
    {
        .name  = bcmltd_strpool_ing_service_pool_cells,  /* ING_SERVICE_POOL_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Ingress service pool threshold shared threshold in cells.",
    },
    {
        .name  = bcmltd_strpool_ing_headroom_pool_cells,  /* ING_HEADROOM_POOL_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Ingress headroom pool threshold threshold in cells.",
    },
    {
        .name  = bcmltd_strpool_egr_service_pool_uc_cells,  /* EGR_SERVICE_POOL_UC_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_service_pool_mc_cells,  /* EGR_SERVICE_POOL_MC_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_bst_service_pool_thd_t = {
    .name = bcmltd_strpool_tm_bst_service_pool_thd, /* TM_BST_SERVICE_POOL_THD */
    .flags = 0,
    .fields = 5,
