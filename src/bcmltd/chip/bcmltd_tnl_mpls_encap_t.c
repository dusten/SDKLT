...
static const bcmltd_field_rep_t bcmltd_tnl_mpls_encap_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_num_labels,  /* NUM_LABELS */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_max_labels,  /* MAX_LABELS */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_mpls_tnl_exp_mode,  /* MPLS_TNL_EXP_MODE */
...
const bcmltd_table_rep_t bcmltd_tnl_mpls_encap_t = {
    .name = bcmltd_strpool_tnl_mpls_encap, /* TNL_MPLS_ENCAP */
    .flags = BCMLTD_TABLE_F_TYPE_INDEX_ALLOC,
    .fields = 14,
    .field = bcmltd_tnl_mpls_encap_t_fields,
    .desc = "\n The TNL_MPLS_ENCAP table is used to set MPLS tunnel parameters\n during encapsulation of packets.\n\n",
};
