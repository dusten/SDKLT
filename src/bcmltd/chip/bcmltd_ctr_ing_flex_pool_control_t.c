...
static const bcmltd_field_rep_t bcmltd_ctr_ing_flex_pool_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_ctr_ing_flex_pool_id,  /* CTR_ING_FLEX_POOL_ID */
    ...
    {
        .name  = bcmltd_strpool_eviction_mode,  /* EVICTION_MODE */
    ...
    {
        .name  = bcmltd_strpool_eviction_thd_bytes,  /* EVICTION_THD_BYTES */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_eviction_thd_pkts,  /* EVICTION_THD_PKTS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_eviction_seed,  /* EVICTION_SEED */
        .flags = 0,
        .width = 64,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ctr_ing_flex_pool_control_t = {
    .name = bcmltd_strpool_ctr_ing_flex_pool_control, /* CTR_ING_FLEX_POOL_CONTROL */
    .flags = 0,
    .fields = 5,
