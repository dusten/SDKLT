 ...
 * This file is auto-generated by fltg from INTERNAL/fltg/xgs/meter/METER_FP_EGR_TEMPLATE.tbl.ltl
...
static const bcmltd_field_rep_t bcmltd_meter_fp_egr_template_t_fields[] = {
    {
        .name  = bcmltd_strpool_meter_fp_egr_template_id,  /* METER_FP_EGR_TEMPLATE_ID */
    ...
    {
        .name  = bcmltd_strpool_meter_fp_egr_pool_id,  /* METER_FP_EGR_POOL_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
        .desc = "Meter Pool Id.",
...
const bcmltd_table_rep_t bcmltd_meter_fp_egr_template_t = {
    .name = bcmltd_strpool_meter_fp_egr_template, /* METER_FP_EGR_TEMPLATE */
    .flags = 0,
    .fields = 22,
    .field = bcmltd_meter_fp_egr_template_t_fields,
    .desc = "",
};
