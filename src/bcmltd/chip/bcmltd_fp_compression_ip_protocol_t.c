...
static const bcmltd_field_rep_t bcmltd_fp_compression_ip_protocol_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_fp_compression_ip_protocol_id,  /* FP_COMPRESSION_IP_PROTOCOL_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_compressed_ip_protocol,  /* COMPRESSED_IP_PROTOCOL */
        .flags = 0,
        .width = 8,
        .depth = 0,
