...
static const bcmltd_field_rep_t bcmltd_phb_egr_mpls_int_pri_to_lsp_exp_t_fields[] = {
    {
        .name  = bcmltd_strpool_phb_egr_mpls_int_pri_to_lsp_exp_id,  /* PHB_EGR_MPLS_INT_PRI_TO_LSP_EXP_ID */
...
const bcmltd_table_rep_t bcmltd_phb_egr_mpls_int_pri_to_lsp_exp_t = {
    .name = bcmltd_strpool_phb_egr_mpls_int_pri_to_lsp_exp, /* PHB_EGR_MPLS_INT_PRI_TO_LSP_EXP */
    .flags = 0,
    .fields = 4,
