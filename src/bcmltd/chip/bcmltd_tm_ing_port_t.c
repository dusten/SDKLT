...
static const bcmltd_field_rep_t bcmltd_tm_ing_port_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_pri_grp_is_lossless,  /* PRI_GRP_IS_LOSSLESS */
        .flags = 0,
        .width = 1,
        .depth = 8,
...
const bcmltd_table_rep_t bcmltd_tm_ing_port_t = {
    .name = bcmltd_strpool_tm_ing_port, /* TM_ING_PORT */
    .flags = 0,
    .fields = 2,
    .field = bcmltd_tm_ing_port_t_fields,
    .desc = "The TM_ING_PORT table specifies the ingress port related TM configuration.\n",
};
