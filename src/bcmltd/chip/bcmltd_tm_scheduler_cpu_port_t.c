...
static const bcmltd_field_rep_t bcmltd_tm_scheduler_cpu_port_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_wdrr_credits,  /* WDRR_CREDITS */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
        .num_sym = 4,
        .sym = bcmltd_common_tm_sched_cpu_credit_wdrr_t_enum,
        .desc = "Credits for the excess bandwidth WDRR scheduling mode.\n Applicable only if WRR is disabled.\n",
    },
    {
        .name  = bcmltd_strpool_wrr_credits,  /* WRR_CREDITS */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
        .num_sym = 4,
        .sym = bcmltd_common_tm_sched_cpu_credit_wrr_t_enum,
...
const bcmltd_table_rep_t bcmltd_tm_scheduler_cpu_port_t = {
    .name = bcmltd_strpool_tm_scheduler_cpu_port, /* TM_SCHEDULER_CPU_PORT */
    .flags = 0,
    .fields = 3,
