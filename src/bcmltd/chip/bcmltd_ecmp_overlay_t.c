...
static const bcmltd_field_rep_t bcmltd_ecmp_overlay_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_nhop_sorted,  /* NHOP_SORTED */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_max_paths,  /* MAX_PATHS */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_paths,  /* NUM_PATHS */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ecmp_underlay_id,  /* ECMP_UNDERLAY_ID */
        .flags = 0,
        .width = 16,
        .depth = 128,
        .desc = "ECMP_UNDERLAY logical table indices.",
    },
    {
    ...
    {
        .name  = bcmltd_strpool_rh_size,  /* RH_SIZE */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ecmp_overlay_t = {
    .name = bcmltd_strpool_ecmp_overlay, /* ECMP_OVERLAY */
    .flags = 0,
    .fields = 9,
    .field = bcmltd_ecmp_overlay_t_fields,
    .desc = "Overlay ECMP group logical table.",
};
