...
static const bcmltd_field_rep_t bcmltd_tm_port_map_info_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_tm_local_port,  /* TM_LOCAL_PORT */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_tm_sparse_global_port,  /* TM_SPARSE_GLOBAL_PORT */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_tm_compact_global_port,  /* TM_COMPACT_GLOBAL_PORT */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_base_uc_q,  /* BASE_UC_Q */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_uc_q,  /* NUM_UC_Q */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_base_mc_q,  /* BASE_MC_Q */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_mc_q,  /* NUM_MC_Q */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_port_map_info_t = {
    .name = bcmltd_strpool_tm_port_map_info, /* TM_PORT_MAP_INFO */
    .flags = 0,
    .fields = 10,
    .field = bcmltd_tm_port_map_info_t_fields,
    .desc = "The TM_PORT_MAP_INFO table provides port numbers and UC\n associated with a logical port.\n",
};
