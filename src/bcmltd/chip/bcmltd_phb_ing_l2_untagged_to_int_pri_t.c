...
static const bcmltd_field_rep_t bcmltd_phb_ing_l2_untagged_to_int_pri_t_fields[] = {
    {
        .name  = bcmltd_strpool_phb_ing_l2_untagged_to_int_pri_id,  /* PHB_ING_L2_UNTAGGED_TO_INT_PRI_ID */
...
const bcmltd_table_rep_t bcmltd_phb_ing_l2_untagged_to_int_pri_t = {
    .name = bcmltd_strpool_phb_ing_l2_untagged_to_int_pri, /* PHB_ING_L2_UNTAGGED_TO_INT_PRI */
    .flags = 0,
    .fields = 3,
