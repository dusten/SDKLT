...
static const bcmltd_field_rep_t bcmltd_fp_ing_higig_eh_mask_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_profile_id,  /* PROFILE_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_eh_mask,  /* EH_MASK */
        .flags = 0,
        .width = 32,
        .depth = 0,
