 ...
 * This file is auto-generated by fltg from INTERNAL/fltg/xgs/meter/METER_FP_ING_TEMPLATE.tbl.ltl
...
static const bcmltd_field_rep_t bcmltd_meter_fp_ing_template_t_fields[] = {
    {
        .name  = bcmltd_strpool_meter_fp_ing_template_id,  /* METER_FP_ING_TEMPLATE_ID */
    ...
    {
        .name  = bcmltd_strpool_meter_fp_ing_pool_id,  /* METER_FP_ING_POOL_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
        .desc = "Meter Pool Id.",
    ...
    {
        .name  = bcmltd_strpool_pkt_mode,  /* PKT_MODE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_meter_mode,  /* METER_MODE */
    ...
    {
        .name  = bcmltd_strpool_color_mode,  /* COLOR_MODE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_min_rate_kbps,  /* MIN_RATE_KBPS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_max_rate_kbps,  /* MAX_RATE_KBPS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_min_rate_kbps_oper,  /* MIN_RATE_KBPS_OPER */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_max_rate_kbps_oper,  /* MAX_RATE_KBPS_OPER */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_min_rate_pps,  /* MIN_RATE_PPS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_max_rate_pps,  /* MAX_RATE_PPS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_min_burst_size_pkts,  /* MIN_BURST_SIZE_PKTS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_max_burst_size_pkts,  /* MAX_BURST_SIZE_PKTS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_min_rate_pps_oper,  /* MIN_RATE_PPS_OPER */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Operational committed rate. This is a read-only field which\n reflects any modification to the configured MIN_RATE value\n as a function of REFRESHCOUNT and BUCKETSIZE fields.\n Valid only if PKT_MODE is enabled.\n",
    ...
    {
        .name  = bcmltd_strpool_max_rate_pps_oper,  /* MAX_RATE_PPS_OPER */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Operational peak rate. This is a read-only field which\n reflects any modification to the configured MAX_RATE value\n as a function of REFRESHCOUNT and BUCKETSIZE fields.\n Valid only if PKT_MODE is enabled.\n",
    ...
    {
        .name  = bcmltd_strpool_min_burst_size_pkts_oper,  /* MIN_BURST_SIZE_PKTS_OPER */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Operational committed burst size. This is a read-only field.\n Valid only if PKT_MODE is enabled.\n",
    ...
    {
        .name  = bcmltd_strpool_max_burst_size_pkts_oper,  /* MAX_BURST_SIZE_PKTS_OPER */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Operational peak burst size. This is a read-only field.\n Valid only if PKT_MODE is enabled.\n",
...
const bcmltd_table_rep_t bcmltd_meter_fp_ing_template_t = {
    .name = bcmltd_strpool_meter_fp_ing_template, /* METER_FP_ING_TEMPLATE */
    .flags = 0,
    .fields = 22,
    .field = bcmltd_meter_fp_ing_template_t_fields,
    .desc = "",
};
