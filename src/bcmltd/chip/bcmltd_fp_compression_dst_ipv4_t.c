...
static const bcmltd_field_rep_t bcmltd_fp_compression_dst_ipv4_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_compressed_dst_ipv4,  /* COMPRESSED_DST_IPV4 */
        .flags = 0,
        .width = 64,
        .depth = 0,
