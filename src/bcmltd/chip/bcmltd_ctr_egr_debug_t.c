...
static const bcmltd_field_rep_t bcmltd_ctr_egr_debug_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_debug_0,  /* DEBUG_0 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_1,  /* DEBUG_1 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_2,  /* DEBUG_2 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_3,  /* DEBUG_3 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_4,  /* DEBUG_4 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_5,  /* DEBUG_5 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_6,  /* DEBUG_6 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_7,  /* DEBUG_7 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_8,  /* DEBUG_8 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_9,  /* DEBUG_9 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_10,  /* DEBUG_10 */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_debug_11,  /* DEBUG_11 */
        .flags = 0,
        .width = 64,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ctr_egr_debug_t = {
    .name = bcmltd_strpool_ctr_egr_debug, /* CTR_EGR_DEBUG */
    .flags = 0,
    .fields = 13,
