...
static const bcmltd_field_rep_t bcmltd_tm_oobfc_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_gcs_report,  /* GCS_REPORT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_service_pool_id,  /* SERVICE_POOL_ID */
        .flags = 0,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_service_pool_report,  /* SERVICE_POOL_REPORT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_pool_channel_base,  /* POOL_CHANNEL_BASE */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ingress_report,  /* INGRESS_REPORT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ingress_channel_base,  /* INGRESS_CHANNEL_BASE */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egress_report,  /* EGRESS_REPORT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egress_channel_base,  /* EGRESS_CHANNEL_BASE */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egress_status_size,  /* EGRESS_STATUS_SIZE */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
        .num_sym = 2,
        .sym = bcmltd_common_oobfc_egress_size_t_enum,
        .desc = "Egress congestion status representation size.\n Valid values are 8 bit and 16 bit.\n",
    },
    {
        .name  = bcmltd_strpool_inter_packet_gap,  /* INTER_PACKET_GAP */
        .flags = 0,
        .width = 32,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_oobfc_control_t = {
    .name = bcmltd_strpool_tm_oobfc_control, /* TM_OOBFC_CONTROL */
    .flags = 0,
    .fields = 10,
