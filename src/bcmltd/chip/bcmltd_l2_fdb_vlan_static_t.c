...
static const bcmltd_field_rep_t bcmltd_l2_fdb_vlan_static_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_skip_learning,  /* SKIP_LEARNING */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_l2_protocol_pkt,  /* L2_PROTOCOL_PKT */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_l2_fdb_vlan_static_t = {
    .name = bcmltd_strpool_l2_fdb_vlan_static, /* L2_FDB_VLAN_STATIC */
