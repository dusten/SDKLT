...
static const bcmltd_field_rep_t bcmltd_trunk_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_uc_hash_use_src_port,  /* UC_HASH_USE_SRC_PORT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_nonuc_hash_use_dst,  /* NONUC_HASH_USE_DST */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_nonuc_hash_use_src_port,  /* NONUC_HASH_USE_SRC_PORT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_nonuc_hash_use_src,  /* NONUC_HASH_USE_SRC */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_nonuc_hash_use_lb_hash,  /* NONUC_HASH_USE_LB_HASH */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_lb_hash_use_flow_uc,  /* LB_HASH_USE_FLOW_UC */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_lb_hash_use_flow_nonuc,  /* LB_HASH_USE_FLOW_NONUC */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_lb_hash_use_flow_failover,  /* LB_HASH_USE_FLOW_FAILOVER */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_trunk_control_t = {
    .name = bcmltd_strpool_trunk_control, /* TRUNK_CONTROL */
    .flags = 0,
    .fields = 8,
