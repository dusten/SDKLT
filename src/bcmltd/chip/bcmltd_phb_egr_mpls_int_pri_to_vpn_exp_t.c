...
static const bcmltd_field_rep_t bcmltd_phb_egr_mpls_int_pri_to_vpn_exp_t_fields[] = {
    {
        .name  = bcmltd_strpool_phb_egr_mpls_int_pri_to_vpn_exp_id,  /* PHB_EGR_MPLS_INT_PRI_TO_VPN_EXP_ID */
    ...
    {
        .name  = bcmltd_strpool_mpls_exp,  /* MPLS_EXP */
        .flags = 0,
        .width = 3,
        .depth = 0,
