...
const bcmltd_table_rep_t bcmltd_mirror_encap_rspan_t = {
    .name = bcmltd_strpool_mirror_encap_rspan, /* MIRROR_ENCAP_RSPAN */
    .flags = BCMLTD_TABLE_F_TYPE_INDEX_ALLOC,
    .fields = 3,
    .field = bcmltd_mirror_encap_rspan_t_fields,
    .desc = "The MIRROR_ENCAP_RSPAN logical table is used for\n specifying RSPAN encapsulation configuration.\n",
};
