...
static const bcmltd_field_rep_t bcmltd_ser_injection_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_xor_bank,  /* XOR_BANK */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_inject_err_bit_num,  /* INJECT_ERR_BIT_NUM */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_inject_validate,  /* INJECT_VALIDATE */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_time_to_wait,  /* TIME_TO_WAIT */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Time (nanoseconds) to wait for SER correction.",
    },
};
const bcmltd_table_rep_t bcmltd_ser_injection_t = {
    .name = bcmltd_strpool_ser_injection, /* SER_INJECTION */
    .flags = 0,
    .fields = 7,
