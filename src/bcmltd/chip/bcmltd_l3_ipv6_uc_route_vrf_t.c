...
static const bcmltd_field_rep_t bcmltd_l3_ipv6_uc_route_vrf_t_fields[] = {
    {
        .name  = bcmltd_strpool_ipv6_upper,  /* IPV6_UPPER */
    ...
    {
        .name  = bcmltd_strpool_ipv6_upper_mask,  /* IPV6_UPPER_MASK */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ipv6_lower,  /* IPV6_LOWER */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 64,
        .depth = 0,
        .desc = "IPV6 address.",
    ...
    {
        .name  = bcmltd_strpool_ipv6_lower_mask,  /* IPV6_LOWER_MASK */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 64,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_l3_ipv6_uc_route_vrf_t = {
    .name = bcmltd_strpool_l3_ipv6_uc_route_vrf, /* L3_IPV6_UC_ROUTE_VRF */
    .flags = BCMLTD_TABLE_F_TYPE_TCAM,
    .fields = 15,
    .field = bcmltd_l3_ipv6_uc_route_vrf_t_fields,
    .desc = "The L3_IPV6_UC_VRF table is used to configure VRF IPv6 routes.",
};
