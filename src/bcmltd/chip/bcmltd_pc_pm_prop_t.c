...
static const bcmltd_field_rep_t bcmltd_pc_pm_prop_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_pm_type,  /* PM_TYPE */
    ...
    {
        .name  = bcmltd_strpool_num_lanes,  /* NUM_LANES */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_ports,  /* NUM_PORTS */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_aggr,  /* NUM_AGGR */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_pc_pm_prop_t = {
    .name = bcmltd_strpool_pc_pm_prop, /* PC_PM_PROP */
    .flags = 0,
    .fields = 5,
    .field = bcmltd_pc_pm_prop_t_fields,
    .desc = "Port macro properties.\n",
};
