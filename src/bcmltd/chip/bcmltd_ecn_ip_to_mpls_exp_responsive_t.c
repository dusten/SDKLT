...
static const bcmltd_field_rep_t bcmltd_ecn_ip_to_mpls_exp_responsive_t_fields[] = {
    {
        .name  = bcmltd_strpool_ecn_ip_to_mpls_exp_responsive_id,  /* ECN_IP_TO_MPLS_EXP_RESPONSIVE_ID */
...
const bcmltd_table_rep_t bcmltd_ecn_ip_to_mpls_exp_responsive_t = {
    .name = bcmltd_strpool_ecn_ip_to_mpls_exp_responsive, /* ECN_IP_TO_MPLS_EXP_RESPONSIVE */
    .flags = 0,
    .fields = 7,
