...
static const bcmltd_field_rep_t bcmltd_fp_compression_src_l4_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_fp_compression_src_l4_id,  /* FP_COMPRESSION_SRC_L4_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_src_l4_type,  /* SRC_L4_TYPE */
    ...
    {
        .name  = bcmltd_strpool_src_l4,  /* SRC_L4 */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_compressed_src_l4,  /* COMPRESSED_SRC_L4 */
        .flags = 0,
        .width = 8,
        .depth = 0,
