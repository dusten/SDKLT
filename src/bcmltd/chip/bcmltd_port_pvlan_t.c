...
static const bcmltd_field_rep_t bcmltd_port_pvlan_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_ing_pvlan,  /* ING_PVLAN */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_pvlan,  /* EGR_PVLAN */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_replace_pri,  /* EGR_REPLACE_PRI */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_pri,  /* EGR_PRI */
        .flags = 0,
        .width = 3,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_untag,  /* EGR_UNTAG */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_vid,  /* EGR_VID */
        .flags = 0,
        .width = 12,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_port_pvlan_t = {
    .name = bcmltd_strpool_port_pvlan, /* PORT_PVLAN */
    .flags = 0,
    .fields = 7,
