...
static const bcmltd_field_rep_t bcmltd_ecn_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_non_ip_responsive,  /* NON_IP_RESPONSIVE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_responsive_non_ip_ecn_cng,  /* RESPONSIVE_NON_IP_ECN_CNG */
        .flags = 0,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_non_responsive_non_ip_ecn_cng,  /* NON_RESPONSIVE_NON_IP_ECN_CNG */
        .flags = 0,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_use_payload_ip_proto_for_responsive,  /* USE_PAYLOAD_IP_PROTO_FOR_RESPONSIVE */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ecn_control_t = {
    .name = bcmltd_strpool_ecn_control, /* ECN_CONTROL */
    .flags = 0,
    .fields = 4,
