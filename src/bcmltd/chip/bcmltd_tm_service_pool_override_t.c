...
static const bcmltd_field_rep_t bcmltd_tm_service_pool_override_t_fields[] = {
    {
        .name  = bcmltd_strpool_mc_override,  /* MC_OVERRIDE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_mc_service_pool,  /* MC_SERVICE_POOL */
        .flags = 0,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_cpu_override,  /* CPU_OVERRIDE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_cpu_service_pool,  /* CPU_SERVICE_POOL */
        .flags = 0,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_mirror_override,  /* MIRROR_OVERRIDE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_mirror_service_pool,  /* MIRROR_SERVICE_POOL */
        .flags = 0,
        .width = 2,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_service_pool_override_t = {
    .name = bcmltd_strpool_tm_service_pool_override, /* TM_SERVICE_POOL_OVERRIDE */
    .flags = 0,
    .fields = 6,
    .field = bcmltd_tm_service_pool_override_t_fields,
    .desc = "The TM_SERVICE_POOL_OVERRIDE table configures service pool override\n for different flows.\n",
};
