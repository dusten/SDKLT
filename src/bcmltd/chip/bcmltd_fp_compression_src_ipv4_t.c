...
static const bcmltd_field_rep_t bcmltd_fp_compression_src_ipv4_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_compressed_src_ipv4,  /* COMPRESSED_SRC_IPV4 */
        .flags = 0,
        .width = 64,
        .depth = 0,
