...
static const bcmltd_field_rep_t bcmltd_fp_ing_redirect_data_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_fp_ing_redirect_data_id,  /* FP_ING_REDIRECT_DATA_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 16,
        .depth = 0,
        .desc = "",
    ...
    {
        .name  = bcmltd_strpool_redirect_port_bitmap,  /* REDIRECT_PORT_BITMAP */
        .flags = 0,
        .width = 256,
        .depth = 0,
        .desc = "This bitmap is used to replace the actual Destination PBMP of the\n packet assigned by the pipeline.\n",
    },
    {
        .name  = bcmltd_strpool_higig_trunk_override_bitmap_id,  /* HIGIG_TRUNK_OVERRIDE_BITMAP_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_fp_ing_redirect_data_t = {
    .name = bcmltd_strpool_fp_ing_redirect_data, /* FP_ING_REDIRECT_DATA */
    .flags = 0,
    .fields = 4,
    .field = bcmltd_fp_ing_redirect_data_t_fields,
    .desc = "actions supported in IFP_POLICY_TABLE.\n",
};
