...
static const bcmltd_field_rep_t bcmltd_tm_thd_mc_q_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_tm_thd_mc_q_id,  /* TM_THD_MC_Q_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
    ...
    },
    {
        ...
        .width = 32,
        .depth = 0,
        .desc = "Minimum guranteed in cells.",
    },
    {
...
const bcmltd_table_rep_t bcmltd_tm_thd_mc_q_t = {
    .name = bcmltd_strpool_tm_thd_mc_q, /* TM_THD_MC_Q */
    .flags = 0,
    .fields = 18,
    .field = bcmltd_tm_thd_mc_q_t_fields,
    .desc = "The TM_THD_MC_Q table specifies threshold configurations for multicast\n queues.\n",
};
