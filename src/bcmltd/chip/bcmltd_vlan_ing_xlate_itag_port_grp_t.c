...
static const bcmltd_field_rep_t bcmltd_vlan_ing_xlate_itag_port_grp_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_vlan_action,  /* VLAN_ACTION */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_l3_iif_valid,  /* L3_IIF_VALID */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_vlan_ing_xlate_itag_port_grp_t = {
    .name = bcmltd_strpool_vlan_ing_xlate_itag_port_grp, /* VLAN_ING_XLATE_ITAG_PORT_GRP */
