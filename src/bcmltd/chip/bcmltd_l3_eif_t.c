...
static const bcmltd_field_rep_t bcmltd_l3_eif_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_mac_sa,  /* MAC_SA */
        .flags = 0,
        .width = 48,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_phb_egr_l2_otag_action,  /* PHB_EGR_L2_OTAG_ACTION */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_phb_egr_l2_itag_action,  /* PHB_EGR_L2_ITAG_ACTION */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_l2_switch,  /* L2_SWITCH */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    },
    {
        ...
        .width = 16,
        .depth = 0,
        .desc = "TNL_IPV4_ENCAP logical table index. Applicable only\n when TNL_TYPE == IPV4.\n TNL_IPV6_ENCAP logical table index. Applicable only\n when TNL_TYPE == IPV6.\n TNL_MPLS_ENCAP logical table index. Applicable only\n when TNL_TYPE == MPLS.\n",
    },
};
const bcmltd_table_rep_t bcmltd_l3_eif_t = {
    .name = bcmltd_strpool_l3_eif, /* L3_EIF */
    .flags = 0,
    .fields = 19,
