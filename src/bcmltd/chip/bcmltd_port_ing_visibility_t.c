...
static const bcmltd_field_rep_t bcmltd_port_ing_visibility_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_timestamp_origin,  /* TIMESTAMP_ORIGIN */
        .flags = 0,
        .width = 23,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_skip_timestamp,  /* SKIP_TIMESTAMP */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_port_ing_visibility_t = {
    .name = bcmltd_strpool_port_ing_visibility, /* PORT_ING_VISIBILITY */
    .flags = 0,
    .fields = 4,
    .field = bcmltd_port_ing_visibility_t_fields,
    .desc = "The PORT_ING_VISIBILITY table specifies the per ingress port visibility configuration.\n",
};
