...
static const bcmltd_field_rep_t bcmltd_lb_hash_seed_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_hash0_seed,  /* HASH0_SEED */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Hash seed input for HASH 0/1.",
    },
    {
        .name  = bcmltd_strpool_hash1_seed,  /* HASH1_SEED */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "",
...
const bcmltd_table_rep_t bcmltd_lb_hash_seed_control_t = {
    .name = bcmltd_strpool_lb_hash_seed_control, /* LB_HASH_SEED_CONTROL */
    .flags = 0,
    .fields = 2,
