...
static const bcmltd_field_rep_t bcmltd_lb_hash_flow_ecmp_output_selection_t_fields[] = {
    {
        .name  = bcmltd_strpool_lb_hash_flow_ecmp_output_selection_id,  /* LB_HASH_FLOW_ECMP_OUTPUT_SELECTION_ID */
    ...
    {
        .name  = bcmltd_strpool_level2_concat,  /* LEVEL2_CONCAT */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable to use concatenate mode: treat hash outputs as 1 \n 64-bit field.\n Disable to use non-concatenate mode: treat hash outputs as 4 \n 16-bit fields.\n",
    },
    {
        .name  = bcmltd_strpool_level2_subset_select,  /* LEVEL2_SUBSET_SELECT */
    ...
    {
        .name  = bcmltd_strpool_level2_offset,  /* LEVEL2_OFFSET */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_concat,  /* CONCAT */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable to use concatenate mode: treat hash outputs as 1 \n 64-bit field.\n Disable to use non-concatenate mode: treat hash outputs as 4 \n 16-bit fields.\n",
    ...
    {
        .name  = bcmltd_strpool_subset_select,  /* SUBSET_SELECT */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
