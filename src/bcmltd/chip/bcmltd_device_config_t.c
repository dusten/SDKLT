...
static const bcmltd_field_rep_t bcmltd_device_config_t_fields[] = {
    {
        .name  = bcmltd_strpool_core_clk_freq,  /* CORE_CLK_FREQ */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
        .num_sym = 4,
        .sym = bcmltd_common_device_clk_freq_t_enum,
        .desc = "Core clock frequency.",
    },
    {
        .name  = bcmltd_strpool_pp_clk_freq,  /* PP_CLK_FREQ */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
        .num_sym = 4,
    ...
    {
        .name  = bcmltd_strpool_chip_debug,  /* CHIP_DEBUG */
        .flags = 0,
        .width = 64,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_device_config_t = {
    .name = bcmltd_strpool_device_config, /* DEVICE_CONFIG */
