...
static const bcmltd_field_rep_t bcmltd_lm_port_control_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_linkscan_mode,  /* LINKSCAN_MODE */
    ...
    {
        .name  = bcmltd_strpool_override_link_state,  /* OVERRIDE_LINK_STATE */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Link status of those ports with override mode.",
    },
};
const bcmltd_table_rep_t bcmltd_lm_port_control_t = {
    .name = bcmltd_strpool_lm_port_control, /* LM_PORT_CONTROL */
    .flags = 0,
    .fields = 3,
