...
static const bcmltd_field_rep_t bcmltd_meter_storm_control_map_t_fields[] = {
    {
        .name  = bcmltd_strpool_bcast_meter_id,  /* BCAST_METER_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_known_l2mc_meter_id,  /* KNOWN_L2MC_METER_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_unknown_l2mc_meter_id,  /* UNKNOWN_L2MC_METER_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_known_ipmc_meter_id,  /* KNOWN_IPMC_METER_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_unknown_ipmc_meter_id,  /* UNKNOWN_IPMC_METER_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_dlf_meter_id,  /* DLF_METER_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_meter_storm_control_map_t = {
    .name = bcmltd_strpool_meter_storm_control_map, /* METER_STORM_CONTROL_MAP */
    .flags = 0,
    .fields = 6,
    .field = bcmltd_meter_storm_control_map_t_fields,
    .desc = "Map packet type to meter index for storm control meters.\n",
};
