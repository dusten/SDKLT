...
static const bcmltd_field_rep_t bcmltd_fp_compression_src_ipv6_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_src_ipv6_upper_mask,  /* SRC_IPV6_UPPER_MASK */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_src_ipv6_lower_mask,  /* SRC_IPV6_LOWER_MASK */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_compressed_src_ipv6,  /* COMPRESSED_SRC_IPV6 */
        .flags = 0,
        .width = 64,
        .depth = 0,
