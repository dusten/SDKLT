...
static const bcmltd_field_rep_t bcmltd_pc_phys_port_t_fields[] = {
    {
        ...
        .width = 16,
        .depth = 0,
        .desc = "Physical device port number",
    },
    {
    ...
    {
        .name  = bcmltd_strpool_pm_phys_port,  /* PM_PHYS_PORT */
        .flags = 0,
        .width = 16,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_pc_phys_port_t = {
    .name = bcmltd_strpool_pc_phys_port, /* PC_PHYS_PORT */
    .flags = 0,
    .fields = 3,
    .field = bcmltd_pc_phys_port_t_fields,
    .desc = "Physical device port table.\n\n Physical device port to port macro ID mapping.\n",
};
