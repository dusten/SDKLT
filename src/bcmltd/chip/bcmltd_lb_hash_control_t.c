...
static const bcmltd_field_rep_t bcmltd_lb_hash_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_l3_hash_alg,  /* L3_HASH_ALG */
    ...
    {
        .name  = bcmltd_strpool_l2_hash_alg,  /* L2_HASH_ALG */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_lbid_compute,  /* LBID_COMPUTE */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_use_tcp_udp_port,  /* USE_TCP_UDP_PORT */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_lb_hash_control_t = {
    .name = bcmltd_strpool_lb_hash_control, /* LB_HASH_CONTROL */
    .flags = 0,
    .fields = 4,
