...
static const bcmltd_field_rep_t bcmltd_tm_scheduler_sp_profile_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_strict_priority,  /* STRICT_PRIORITY */
        .flags = 0,
        .width = 1,
        .depth = 12,
    ...
    {
        .name  = bcmltd_strpool_strict_priority_oper,  /* STRICT_PRIORITY_OPER */
        .flags = 0,
        .width = 1,
        .depth = 12,
...
const bcmltd_table_rep_t bcmltd_tm_scheduler_sp_profile_t = {
    .name = bcmltd_strpool_tm_scheduler_sp_profile, /* TM_SCHEDULER_SP_PROFILE */
    .flags = 0,
    .fields = 3,
