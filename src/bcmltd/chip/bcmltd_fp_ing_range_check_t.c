...
static const bcmltd_field_rep_t bcmltd_fp_ing_range_check_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_fp_ing_range_check_id,  /* FP_ING_RANGE_CHECK_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_min_value,  /* MIN_VALUE */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_udf1_chunk2_mask,  /* UDF1_CHUNK2_MASK */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_rules,  /* NUM_RULES */
        .flags = 0,
        .width = 32,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_fp_ing_range_check_t = {
    .name = bcmltd_strpool_fp_ing_range_check, /* FP_ING_RANGE_CHECK */
    .flags = 0,
    .fields = 7,
    .field = bcmltd_fp_ing_range_check_t_fields,
    .desc = "Logical Table to create range check for different packet and meta data\n fields.\n",
};
