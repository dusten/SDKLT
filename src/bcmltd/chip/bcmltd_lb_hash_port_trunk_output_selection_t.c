...
static const bcmltd_field_rep_t bcmltd_lb_hash_port_trunk_output_selection_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_uc_concat,  /* UC_CONCAT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_uc_subset_select,  /* UC_SUBSET_SELECT */
    ...
    {
        .name  = bcmltd_strpool_uc_offset,  /* UC_OFFSET */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_nonuc_concat,  /* NONUC_CONCAT */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable to use concatenate mode: treat hash outputs as 1 \n 64-bit field.\n Disable to use non-concatenate mode: treat hash outputs as 4 \n 16-bit fields.\n",
    ...
    {
        .name  = bcmltd_strpool_nonuc_subset_select,  /* NONUC_SUBSET_SELECT */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_nonuc_offset,  /* NONUC_OFFSET */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_lb_hash_port_trunk_output_selection_t = {
    .name = bcmltd_strpool_lb_hash_port_trunk_output_selection, /* LB_HASH_PORT_TRUNK_OUTPUT_SELECTION */
    .flags = 0,
    .fields = 7,
