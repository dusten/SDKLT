...
static const bcmltd_field_rep_t bcmltd_ecn_tnl_encap_non_ip_payload_t_fields[] = {
    {
        .name  = bcmltd_strpool_ecn_tnl_encap_non_ip_payload_id,  /* ECN_TNL_ENCAP_NON_IP_PAYLOAD_ID */
...
const bcmltd_table_rep_t bcmltd_ecn_tnl_encap_non_ip_payload_t = {
    .name = bcmltd_strpool_ecn_tnl_encap_non_ip_payload, /* ECN_TNL_ENCAP_NON_IP_PAYLOAD */
    .flags = 0,
    .fields = 2,
