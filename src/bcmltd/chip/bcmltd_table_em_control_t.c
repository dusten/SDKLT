...
static const bcmltd_field_rep_t bcmltd_table_em_control_t_fields[] = {
    ...
    },
    {
        ...
        .width = 32,
        .depth = 0,
        .desc = "Device Exact Match Group ID",
    },
    {
        .name  = bcmltd_strpool_move_depth,  /* MOVE_DEPTH */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_table_em_control_t = {
    .name = bcmltd_strpool_table_em_control, /* TABLE_EM_CONTROL */
    .flags = 0,
    .fields = 3,
    .field = bcmltd_table_em_control_t_fields,
    .desc = "Logical Table for generic exact match control.",
};
