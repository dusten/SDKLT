...
static const bcmltd_field_rep_t bcmltd_port_lb_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_lb_hash_port_lb_num,  /* LB_HASH_PORT_LB_NUM */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_offset_trunk_random,  /* OFFSET_TRUNK_RANDOM */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_offset_ecmp_random,  /* OFFSET_ECMP_RANDOM */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_offset_ecmp_level2_random,  /* OFFSET_ECMP_LEVEL2_RANDOM */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_port_lb_t = {
    .name = bcmltd_strpool_port_lb, /* PORT_LB */
    .flags = 0,
    .fields = 5,
