...
static const bcmltd_field_rep_t bcmltd_l3_uc_nhop_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_mac_da,  /* MAC_DA */
        .flags = 0,
        .width = 48,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_keep_mac_da,  /* KEEP_MAC_DA */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_keep_mac_sa,  /* KEEP_MAC_SA */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_keep_ttl,  /* KEEP_TTL */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_keep_vlan,  /* KEEP_VLAN */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_l3_uc_nhop_t = {
    .name = bcmltd_strpool_l3_uc_nhop, /* L3_UC_NHOP */
    .flags = 0,
    .fields = 16,
