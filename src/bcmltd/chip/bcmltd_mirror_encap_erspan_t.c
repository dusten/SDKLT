...
static const bcmltd_field_rep_t bcmltd_mirror_encap_erspan_t_fields[] = {
    {
        .name  = bcmltd_strpool_mirror_encap_id,  /* MIRROR_ENCAP_ID */
    ...
    {
        .name  = bcmltd_strpool_untag,  /* UNTAG */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_proto,  /* PROTO */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_do_not_fragment,  /* DO_NOT_FRAGMENT */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ethertype,  /* ETHERTYPE */
        .flags = 0,
        .width = 16,
        .depth = 0,
        .desc = "Ethertype.",
    ...
    {
        .name  = bcmltd_strpool_outer_vlan,  /* OUTER_VLAN */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_tpid,  /* TPID */
        .flags = 0,
        .width = 16,
        .depth = 0,
        .desc = "TPID for VLAN tag. Applicable only if OUTER_VLAN is enabled.",
    },
    {
        .name  = bcmltd_strpool_gre_header,  /* GRE_HEADER */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "GRE header.",
...
const bcmltd_table_rep_t bcmltd_mirror_encap_erspan_t = {
    .name = bcmltd_strpool_mirror_encap_erspan, /* MIRROR_ENCAP_ERSPAN */
    .flags = BCMLTD_TABLE_F_TYPE_INDEX_ALLOC,
    .fields = 15,
    .field = bcmltd_mirror_encap_erspan_t_fields,
    .desc = "The MIRROR_ENCAP_ERSPAN logical table is used for\n specifying ERSPAN encapsulation configuration.\n",
};
