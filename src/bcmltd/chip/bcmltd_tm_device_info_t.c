...
static const bcmltd_field_rep_t bcmltd_tm_device_info_t_fields[] = {
    {
        .name  = bcmltd_strpool_max_pkt_size,  /* MAX_PKT_SIZE */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_pkt_hdr_size,  /* PKT_HDR_SIZE */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_jumbo_pkt_size,  /* JUMBO_PKT_SIZE */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_default_mtu,  /* DEFAULT_MTU */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_cell_size,  /* CELL_SIZE */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_cells,  /* NUM_CELLS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_port_pri_grp,  /* NUM_PORT_PRI_GRP */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_service_pool,  /* NUM_SERVICE_POOL */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_num_q,  /* NUM_Q */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_device_info_t = {
    .name = bcmltd_strpool_tm_device_info, /* TM_DEVICE_INFO */
    .flags = 0,
    .fields = 9,
