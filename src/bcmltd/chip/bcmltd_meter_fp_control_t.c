...
static const bcmltd_field_rep_t bcmltd_meter_fp_control_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_byte_count_ing,  /* BYTE_COUNT_ING */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_byte_count_egr,  /* BYTE_COUNT_EGR */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_meter_fp_control_t = {
    .name = bcmltd_strpool_meter_fp_control, /* METER_FP_CONTROL */
    .flags = 0,
    .fields = 3,
    .field = bcmltd_meter_fp_control_t_fields,
    .desc = "Configure number of extra bytes to be added to\n the packet byte count for metering.\n",
};
