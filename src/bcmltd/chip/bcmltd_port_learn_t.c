...
static const bcmltd_field_rep_t bcmltd_port_learn_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_mac_learn,  /* MAC_LEARN */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_mac_copy_to_cpu,  /* MAC_COPY_TO_CPU */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_mac_learn_as_pending,  /* MAC_LEARN_AS_PENDING */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_mac_drop,  /* MAC_DROP */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_port_learn_t = {
    .name = bcmltd_strpool_port_learn, /* PORT_LEARN */
    .flags = 0,
    .fields = 5,
