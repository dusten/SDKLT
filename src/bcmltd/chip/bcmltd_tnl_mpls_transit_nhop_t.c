...
static const bcmltd_field_rep_t bcmltd_tnl_mpls_transit_nhop_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_tnl_mpls_transit_id,  /* TNL_MPLS_TRANSIT_ID */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_label_preserve,  /* LABEL_PRESERVE */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable to preserve the label.",
    },
    {
...
const bcmltd_table_rep_t bcmltd_tnl_mpls_transit_nhop_t = {
    .name = bcmltd_strpool_tnl_mpls_transit_nhop, /* TNL_MPLS_TRANSIT_NHOP */
