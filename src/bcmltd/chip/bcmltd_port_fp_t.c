...
static const bcmltd_field_rep_t bcmltd_port_fp_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_fp_vlan,  /* FP_VLAN */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable VLAN FP.",
    ...
    {
        .name  = bcmltd_strpool_fp_ing,  /* FP_ING */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_fp_egr,  /* FP_EGR */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_use_table_fp_vlan_port_grp,  /* USE_TABLE_FP_VLAN_PORT_GRP */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_fp_ing_grp_sel_class_id,  /* FP_ING_GRP_SEL_CLASS_ID */
        .flags = 0,
        .width = 12,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_fp_egr_port_grp,  /* FP_EGR_PORT_GRP */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_fp_egr_drop,  /* FP_EGR_DROP */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable egress FP drop if the egress FP stage\n is not bypassed and the egress FP policy\n does not explicitly permit the packet.\n",
    },
};
const bcmltd_table_rep_t bcmltd_port_fp_t = {
    .name = bcmltd_strpool_port_fp, /* PORT_FP */
    .flags = 0,
    .fields = 9,
