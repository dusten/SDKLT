...
static const bcmltd_field_rep_t bcmltd_ctr_niv_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_ing_niv_rx_pkts_error_drop,  /* ING_NIV_RX_PKTS_ERROR_DROP */
        .flags = 0,
        .width = 64,
        .depth = 0,
        .desc = "Number of packets dropped due to VNTAG\n format errors.\n",
    },
    {
        .name  = bcmltd_strpool_ing_niv_rx_pkts_forwarding_drop,  /* ING_NIV_RX_PKTS_FORWARDING_DROP */
        .flags = 0,
        .width = 64,
        .depth = 0,
        .desc = "Number of packets dropped due to an NIV\n forwarding errors.\n",
    },
    {
        .name  = bcmltd_strpool_ing_niv_rx_pkts_vlan_tagged,  /* ING_NIV_RX_PKTS_VLAN_TAGGED */
        .flags = 0,
        .width = 64,
        .depth = 0,
        .desc = "Number of VLAN tagged packets received from this port.\n This is added to make sure VNTAG\n Changes can be avoided if necessary.\n",
    },
};
const bcmltd_table_rep_t bcmltd_ctr_niv_t = {
    .name = bcmltd_strpool_ctr_niv, /* CTR_NIV */
    .flags = 0,
    .fields = 4,
