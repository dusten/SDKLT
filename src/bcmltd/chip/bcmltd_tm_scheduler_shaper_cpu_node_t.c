...
static const bcmltd_field_rep_t bcmltd_tm_scheduler_shaper_cpu_node_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_tm_scheduler_shaper_cpu_node_id,  /* TM_SCHEDULER_SHAPER_CPU_NODE_ID */
    ...
    {
        .name  = bcmltd_strpool_parent_tm_scheduler_shaper_cpu_node_id,  /* PARENT_TM_SCHEDULER_SHAPER_CPU_NODE_ID */
        .flags = 0,
        .width = 8,
        .depth = 0,
        .desc = "Parent node for TM_SCHEDULER_SHAPER_CPU_NODE_ID.\n Valid only if SCHED_NODE is L1_SCHED_NODE.\n",
    },
    {
...
const bcmltd_table_rep_t bcmltd_tm_scheduler_shaper_cpu_node_t = {
    .name = bcmltd_strpool_tm_scheduler_shaper_cpu_node, /* TM_SCHEDULER_SHAPER_CPU_NODE */
    .flags = 0,
    .fields = 16,
