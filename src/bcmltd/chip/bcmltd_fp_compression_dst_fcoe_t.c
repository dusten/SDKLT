...
static const bcmltd_field_rep_t bcmltd_fp_compression_dst_fcoe_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_dst_fcoe_identifier,  /* DST_FCOE_IDENTIFIER */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_dst_fcoe_identifier_mask,  /* DST_FCOE_IDENTIFIER_MASK */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_compressed_dst_fcoe_identifier,  /* COMPRESSED_DST_FCOE_IDENTIFIER */
        .flags = 0,
        .width = 64,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_fp_compression_dst_fcoe_t = {
    .name = bcmltd_strpool_fp_compression_dst_fcoe, /* FP_COMPRESSION_DST_FCOE */
    .flags = BCMLTD_TABLE_F_TYPE_TCAM,
    .fields = 6,
    .field = bcmltd_fp_compression_dst_fcoe_t_fields,
    .desc = "Logical Table to create compression map for destination FCoE identifier.\n Compressed value can be assigned to a single or range of destination FCoE\n identifier. Compressed value along with original destination FCoE\n identifier are available in FP to match. Destination identifier is a field\n in FCoE Header.\n",
};
