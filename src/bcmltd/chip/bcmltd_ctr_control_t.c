...
static const bcmltd_field_rep_t bcmltd_ctr_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_collection_enable,  /* COLLECTION_ENABLE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ports,  /* PORTS */
        .flags = 0,
        .width = 256,
        .depth = 0,
        .desc = "Ports on which counters are collected.",
    },
    {
        .name  = bcmltd_strpool_interval,  /* INTERVAL */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Base time interval for collection in microseconds.\n A value of 0 disables counter collection.\n",
    },
    {
        .name  = bcmltd_strpool_multiplier_port,  /* MULTIPLIER_PORT */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_multiplier_epipe,  /* MULTIPLIER_EPIPE */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_multiplier_ipipe,  /* MULTIPLIER_IPIPE */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_multiplier_tm,  /* MULTIPLIER_TM */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_multiplier_evict,  /* MULTIPLIER_EVICT */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ctr_control_t = {
    .name = bcmltd_strpool_ctr_control, /* CTR_CONTROL */
    .flags = 0,
    .fields = 8,
    .field = bcmltd_ctr_control_t_fields,
    .desc = "IN MEMORY Logical Table for Counter Control.\n\n The logical table defines the parameters which can be used\n to control the run time behavior of Counter collection.\n",
};
