...
static const bcmltd_field_rep_t bcmltd_table_op_pt_info_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_aggregate_view,  /* AGGREGATE_VIEW */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enabled indicates that an aggregate key+data view of the\n physical table address is specified in\n PT_ID, PT_INDEX and PT_INSTANCE.\n Disabled indicates that a non-aggregate view of the\n physical table address is provided. The key address is\n specified in PT_ID, PT_INDEX.\n The data address is specified in PT_ID_DATA, PT_INDEX_DATA.\n",
    },
    {
    ...
    {
        .name  = bcmltd_strpool_pt_id_cnt,  /* PT_ID_CNT */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Count of valid entries in the PT_ID array.",
    },
    {
    ...
    {
        .name  = bcmltd_strpool_pt_index_cnt,  /* PT_INDEX_CNT */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_pt_id_data_cnt,  /* PT_ID_DATA_CNT */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_pt_id_data,  /* PT_ID_DATA */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 4,
    ...
    {
        .name  = bcmltd_strpool_pt_index_data_cnt,  /* PT_INDEX_DATA_CNT */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_pt_index_data,  /* PT_INDEX_DATA */
        .flags = 0,
        .width = 32,
        .depth = 4,
...
const bcmltd_table_rep_t bcmltd_table_op_pt_info_t = {
    .name = bcmltd_strpool_table_op_pt_info, /* TABLE_OP_PT_INFO */
    .flags = 0,
    .fields = 11,
