...
static const bcmltd_field_rep_t bcmltd_tnl_ipv4_encap_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_tnl_ttl,  /* TNL_TTL */
        .flags = 0,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ipv4_in_ipv4_df_mode,  /* IPV4_IN_IPV4_DF_MODE */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ipv6_in_ipv4_df_mode,  /* IPV6_IN_IPV4_DF_MODE */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tnl_ipv4_encap_t = {
    .name = bcmltd_strpool_tnl_ipv4_encap, /* TNL_IPV4_ENCAP */
    .flags = BCMLTD_TABLE_F_TYPE_INDEX_ALLOC,
    .fields = 15,
    .field = bcmltd_tnl_ipv4_encap_t_fields,
    .desc = "\n The TNL_IPV4_ENCAP table is used to set IPV4 tunnel parameters\n during encapsulation of packets.\n\n",
};
