...
static const bcmltd_field_rep_t bcmltd_mirror_encap_sflow_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_l4_dst_port,  /* L4_DST_PORT */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_l4_src_port,  /* L4_SRC_PORT */
        .flags = 0,
        .width = 16,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_mirror_encap_sflow_t = {
    .name = bcmltd_strpool_mirror_encap_sflow, /* MIRROR_ENCAP_SFLOW */
    .flags = BCMLTD_TABLE_F_TYPE_INDEX_ALLOC,
    .fields = 16,
    .field = bcmltd_mirror_encap_sflow_t_fields,
    .desc = "The MIRROR_ENCAP_SFLOW logical table is used for\n specifying sFlow encapsulation configuration.\n",
};
