...
static const bcmltd_field_rep_t bcmltd_tm_shaper_port_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_bandwidth_kbps,  /* BANDWIDTH_KBPS */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_bandwidth_kbps_oper,  /* BANDWIDTH_KBPS_OPER */
        .flags = 0,
        .width = 32,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_shaper_port_t = {
    .name = bcmltd_strpool_tm_shaper_port, /* TM_SHAPER_PORT */
    .flags = 0,
    .fields = 9,
    .field = bcmltd_tm_shaper_port_t_fields,
    .desc = "The TM_SHAPER_PORT table specifies maximum shapers valuesfor all ports, inclusive\n of all CPU and non-CPU ports.\n",
};
