...
static const bcmltd_field_rep_t bcmltd_lm_link_state_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_link_state,  /* LINK_STATE */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Link state.",
...
const bcmltd_table_rep_t bcmltd_lm_link_state_t = {
    .name = bcmltd_strpool_lm_link_state, /* LM_LINK_STATE */
    .flags = 0,
    .fields = 2,
    .field = bcmltd_lm_link_state_t_fields,
    .desc = "link state maintained by Link manager.\n\n This table defines link state of ports maintained by link manager.\n\n",
};
