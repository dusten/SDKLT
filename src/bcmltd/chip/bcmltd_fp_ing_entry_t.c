...
static const bcmltd_field_rep_t bcmltd_fp_ing_entry_t_fields[] = {
    {
        .name  = bcmltd_strpool_fp_ing_entry_id,  /* FP_ING_ENTRY_ID */
    ...
    {
        .name  = bcmltd_strpool_fp_ing_ctr_id,  /* FP_ING_CTR_ID */
        .flags = 0,
        .width = 64,
        .depth = 0,
