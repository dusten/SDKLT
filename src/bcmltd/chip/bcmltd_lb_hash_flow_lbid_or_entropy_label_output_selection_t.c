...
static const bcmltd_field_rep_t bcmltd_lb_hash_flow_lbid_or_entropy_label_output_selection_t_fields[] = {
    {
        .name  = bcmltd_strpool_lb_hash_flow_lbid_or_entropy_label_output_selection_id,  /* LB_HASH_FLOW_LBID_OR_ENTROPY_LABEL_OUTPUT_SELECTION_ID */
...
const bcmltd_table_rep_t bcmltd_lb_hash_flow_lbid_or_entropy_label_output_selection_t = {
    .name = bcmltd_strpool_lb_hash_flow_lbid_or_entropy_label_output_selection, /* LB_HASH_FLOW_LBID_OR_ENTROPY_LABEL_OUTPUT_SELECTION */
    .flags = 0,
    .fields = 4,
