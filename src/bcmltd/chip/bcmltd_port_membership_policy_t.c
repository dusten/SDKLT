...
static const bcmltd_field_rep_t bcmltd_port_membership_policy_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_ing_vlan_membership_check,  /* ING_VLAN_MEMBERSHIP_CHECK */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_vlan_membership_check,  /* EGR_VLAN_MEMBERSHIP_CHECK */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_port_membership_policy_t = {
    .name = bcmltd_strpool_port_membership_policy, /* PORT_MEMBERSHIP_POLICY */
    .flags = 0,
    .fields = 4,
