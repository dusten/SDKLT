...
static const bcmltd_field_rep_t bcmltd_tm_egr_service_pool_t_fields[] = {
    {
        .name  = bcmltd_strpool_tm_egr_service_pool_id,  /* TM_EGR_SERVICE_POOL_ID */
    ...
    {
        .name  = bcmltd_strpool_oobfc_merge_pool_state,  /* OOBFC_MERGE_POOL_STATE */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable to merge pool congestion state with queue\n congestion state for out of band flow control (OOBFC).\n When disabled, only the queue congestion state is reported.\n",
    },
};
const bcmltd_table_rep_t bcmltd_tm_egr_service_pool_t = {
    .name = bcmltd_strpool_tm_egr_service_pool, /* TM_EGR_SERVICE_POOL */
    .flags = 0,
    .fields = 2,
