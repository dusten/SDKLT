...
static const bcmltd_field_rep_t bcmltd_fp_compression_ethertype_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_fp_compression_ethertype_id,  /* FP_COMPRESSION_ETHERTYPE_ID */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 8,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_compressed_ethertype,  /* COMPRESSED_ETHERTYPE */
        .flags = 0,
        .width = 8,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_fp_compression_ethertype_t = {
    .name = bcmltd_strpool_fp_compression_ethertype, /* FP_COMPRESSION_ETHERTYPE */
    .flags = 0,
    .fields = 4,
    .field = bcmltd_fp_compression_ethertype_t_fields,
    .desc = "Logical Table to create compression map for ethertype in the\n packet. Each entry in this LT will assign one compressed value to one\n ethernet value in the incoming packet.\n It is programming requirement to not have more than one entry with\n same ethertype value(ETHERTYPE).\n",
};
