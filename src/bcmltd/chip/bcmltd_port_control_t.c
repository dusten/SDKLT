...
static const bcmltd_field_rep_t bcmltd_port_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_egr_block_l2,  /* EGR_BLOCK_L2 */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_block_l3,  /* EGR_BLOCK_L3 */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_egr_block_ucast,  /* EGR_BLOCK_UCAST */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_port_control_t = {
    .name = bcmltd_strpool_port_control, /* PORT_CONTROL */
    .flags = 0,
    .fields = 3,
