...
static const bcmltd_field_rep_t bcmltd_ser_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_tcam_scan,  /* TCAM_SCAN */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_tcam_scan_interval,  /* TCAM_SCAN_INTERVAL */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Time between TCAM scans in nanoseconds.",
    },
    {
        .name  = bcmltd_strpool_tcam_scan_chunk_size,  /* TCAM_SCAN_CHUNK_SIZE */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_tcam_entries_read_per_interval,  /* TCAM_ENTRIES_READ_PER_INTERVAL */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sram_scan,  /* SRAM_SCAN */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sram_scan_interval,  /* SRAM_SCAN_INTERVAL */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Time between SCAM scans in nanoseconds.",
    },
    {
        .name  = bcmltd_strpool_sram_scan_chunk_size,  /* SRAM_SCAN_CHUNK_SIZE */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_sram_entries_read_per_interval,  /* SRAM_ENTRIES_READ_PER_INTERVAL */
        .flags = 0,
        .width = 32,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_report_single_bit_ecc,  /* REPORT_SINGLE_BIT_ECC */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_ser_logging,  /* SER_LOGGING */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_erroneous_entries_logging,  /* ERRONEOUS_ENTRIES_LOGGING */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ser_control_t = {
    .name = bcmltd_strpool_ser_control, /* SER_CONTROL */
    .flags = 0,
    .fields = 12,
