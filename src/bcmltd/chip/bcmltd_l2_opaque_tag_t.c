...
static const bcmltd_field_rep_t bcmltd_l2_opaque_tag_t_fields[] = {
    {
        .name  = bcmltd_strpool_l2_opaque_tag_id,  /* L2_OPAQUE_TAG_ID */
    ...
    {
        .name  = bcmltd_strpool_tag_size,  /* TAG_SIZE */
    ...
    {
        .name  = bcmltd_strpool_tag_type,  /* TAG_TYPE */
        .flags = 0,
        .width = 2,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_l2_opaque_tag_t = {
    .name = bcmltd_strpool_l2_opaque_tag, /* L2_OPAQUE_TAG */
    .flags = 0,
    .fields = 4,
