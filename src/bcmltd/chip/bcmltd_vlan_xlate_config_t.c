...
static const bcmltd_field_rep_t bcmltd_vlan_xlate_config_t_fields[] = {
    {
        .name  = bcmltd_strpool_egr_xlate_port_grp,  /* EGR_XLATE_PORT_GRP */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_vlan_xlate_config_t = {
    .name = bcmltd_strpool_vlan_xlate_config, /* VLAN_XLATE_CONFIG */
    .flags = BCMLTD_TABLE_F_CONFIG,
    .fields = 1,
    .field = bcmltd_vlan_xlate_config_t_fields,
    .desc = "Device-level VLAN_XLATE configuration logical table.",
};
