...
static const bcmltd_field_rep_t bcmltd_ecn_wred_update_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_tm_congestion,  /* TM_CONGESTION */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_packet_cng,  /* PACKET_CNG */
        .flags = BCMLTD_FIELD_F_KEY,
        .width = 2,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_responsive,  /* RESPONSIVE */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_new_int_ecn_cng,  /* NEW_INT_ECN_CNG */
        .flags = 0,
        .width = 2,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_ecn_wred_update_t = {
    .name = bcmltd_strpool_ecn_wred_update, /* ECN_WRED_UPDATE */
    .flags = 0,
    .fields = 5,
