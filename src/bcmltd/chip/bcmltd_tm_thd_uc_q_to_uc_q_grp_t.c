...
static const bcmltd_field_rep_t bcmltd_tm_thd_uc_q_to_uc_q_grp_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_use_uc_q_grp_shared_limits,  /* USE_UC_Q_GRP_SHARED_LIMITS */
        .flags = 0,
        .width = 1,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_use_uc_q_grp_min_limits,  /* USE_UC_Q_GRP_MIN_LIMITS */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_thd_uc_q_to_uc_q_grp_t = {
    .name = bcmltd_strpool_tm_thd_uc_q_to_uc_q_grp, /* TM_THD_UC_Q_TO_UC_Q_GRP */
    .flags = 0,
    .fields = 6,
