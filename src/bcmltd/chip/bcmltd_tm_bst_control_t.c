...
static const bcmltd_field_rep_t bcmltd_tm_bst_control_t_fields[] = {
    {
        .name  = bcmltd_strpool_class,  /* CLASS */
        .flags = BCMLTD_FIELD_F_KEY | BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
        .num_sym = 4,
        .sym = bcmltd_common_bst_event_class_t_enum,
        .desc = "Resource class for an event.",
    },
    {
        .name  = bcmltd_strpool_tracking_mode,  /* TRACKING_MODE */
        .flags = BCMLTD_FIELD_F_ENUM,
        .width = 32,
        .depth = 0,
        .num_sym = 2,
        .sym = bcmltd_common_bst_track_mode_type_t_enum,
        .desc = "Select the tracking mode for the resource class.",
    },
    {
        .name  = bcmltd_strpool_clear_on_read,  /* CLEAR_ON_READ */
        .flags = 0,
        .width = 1,
        .depth = 0,
        .desc = "Enable clear on read of BST and drop counters for\n the resource class. Applicable only if\n TRACKING_MODE == HIGHWATERMARK_TRACK.\n",
    },
    {
        .name  = bcmltd_strpool_snapshot,  /* SNAPSHOT */
        .flags = 0,
        .width = 1,
        .depth = 0,
...
const bcmltd_table_rep_t bcmltd_tm_bst_control_t = {
    .name = bcmltd_strpool_tm_bst_control, /* TM_BST_CONTROL */
    .flags = 0,
    .fields = 4,
