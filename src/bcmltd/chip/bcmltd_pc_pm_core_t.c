...
static const bcmltd_field_rep_t bcmltd_pc_pm_core_t_fields[] = {
    ...
    {
        .name  = bcmltd_strpool_core_clk,  /* CORE_CLK */
        .flags = 0,
        .width = 32,
        .depth = 0,
        .desc = "Core clock in kHz. 0 means default value.",
    },
    {
        .name  = bcmltd_strpool_tx_lane_map,  /* TX_LANE_MAP */
        .flags = 0,
        .width = 64,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_rx_lane_map,  /* RX_LANE_MAP */
        .flags = 0,
        .width = 64,
        .depth = 0,
        .desc = "Bits[3:0] is lane 0 mapping, bits[7:4] is lane 1 mapping, etc.",
    ...
    {
        .name  = bcmltd_strpool_tx_polarity_flip,  /* TX_POLARITY_FLIP */
        .flags = 0,
        .width = 16,
        .depth = 0,
    ...
    {
        .name  = bcmltd_strpool_rx_polarity_flip,  /* RX_POLARITY_FLIP */
        .flags = 0,
        .width = 16,
        .depth = 0,
        .desc = "Bit 0 flips lane 0, bit 1 flips lane 1, etc.",
