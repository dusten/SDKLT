...
typedef enum bcmlt_notif_option_e {
    ...
    BCMLT_NOTIF_OPTION_HW,           /*!< Notify after hadrware updated.    */
 ...
 * informaiton associated with the entry.
 *
 * Typical usecase is checking a commit operation status for an entry. It
 ...
 * is assembled using a set of fields that idenify the entry and it's contents.
