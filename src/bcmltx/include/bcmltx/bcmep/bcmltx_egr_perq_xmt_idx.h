/*! \file bcmltx_egr_perq_xmt_idx.h
 *
...
#ifndef BCMLTX_EGR_PERQ_XMT_IDX_H
#define BCMLTX_EGR_PERQ_XMT_IDX_H
...
/*!
 * \brief EGR_PERQ_XMT_COUNTERS.__INDEX/__INSTANCE reverse transform
 *
 * \param [in]  unit          Unit Number.
 * \param [in]  in            EGR_PERQ_XMT_COUNTERS.__INDEX/__INSTANCE.
 * \param [out] out           EGR_PERQ_XMT_COUNTERS.PORT_ID/MC_Q(or UC_Q).
 * \param [in]  arg           Transform arguments.
 *
 * \retval SHR_E_NONE         No errors.
 * \retval !SHR_E_NONE        Failure.
...
#endif /* BCMLTX_EGR_PERQ_XMT_IDX_H */
