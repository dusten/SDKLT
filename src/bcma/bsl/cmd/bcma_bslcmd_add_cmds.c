 ...
 * CLI Cliironment
 *
 * Add CLI commands to control the cliironment.
 */
...
static bcma_cli_command_t cmd_debug = {
    "debug",
    bcma_bslcmd_debug,
    BCMA_BSLCMD_DEBUG_DESC,
    BCMA_BSLCMD_DEBUG_SYNOP,
...
static bcma_cli_command_t cmd_log = {
    "log",
    bcma_bslcmd_log,
    BCMA_BSLCMD_LOG_DESC,
    BCMA_BSLCMD_LOG_SYNOP,
    { BCMA_BSLCMD_LOG_HELP }
};

static bcma_cli_command_t cmd_console = {
    "CONSole",
    bcma_bslcmd_console,
    BCMA_BSLCMD_CONSOLE_DESC,
    BCMA_BSLCMD_CONSOLE_SYNOP,
    { BCMA_BSLCMD_CONSOLE_HELP }
};
