...
static bcma_cli_command_t shcmd_pktdev = {
    "pktdev",
    bcma_bcmpktcmd_dev,
    BCMA_BCMPKTCMD_DEV_DESC,
    BCMA_BCMPKTCMD_DEV_SYNOP,
    { BCMA_BCMPKTCMD_DEV_HELP }
};

static bcma_cli_command_t shcmd_knet = {
    "knet",
    bcma_bcmpktcmd_knet,
    BCMA_BCMPKTCMD_KNET_DESC,
    BCMA_BCMPKTCMD_KNET_SYNOP,
    { BCMA_BCMPKTCMD_KNET_HELP }
};

static bcma_cli_command_t shcmd_unet = {
    "unet",
    bcma_bcmpktcmd_unet,
    BCMA_BCMPKTCMD_UNET_DESC,
    BCMA_BCMPKTCMD_UNET_SYNOP,
    { BCMA_BCMPKTCMD_UNET_HELP }
};

static bcma_cli_command_t shcmd_pkttx = {
    "tx",
    bcma_bcmpktcmd_tx,
    BCMA_BCMPKTCMD_TX_DESC,
    BCMA_BCMPKTCMD_TX_SYNOP,
    { BCMA_BCMPKTCMD_TX_HELP }
};

static bcma_cli_command_t shcmd_pktrx = {
    "rx",
    bcma_bcmpktcmd_rx,
    BCMA_BCMPKTCMD_RX_DESC,
    BCMA_BCMPKTCMD_RX_SYNOP,
    { BCMA_BCMPKTCMD_RX_HELP }
};

static bcma_cli_command_t shcmd_pkttest = {
    "pkttest",
    bcma_bcmpktcmd_pkttest,
    BCMA_BCMPKTCMD_PKTTEST_DESC,
    BCMA_BCMPKTCMD_PKTTEST_SYNOP,
    { BCMA_BCMPKTCMD_PKTTEST_HELP }
};
...
bcma_bcmpktcmd_add_cmds(bcma_cli_t *cli)
{
    ...
    bcma_cli_add_command(cli, &shcmd_unet, 0);
