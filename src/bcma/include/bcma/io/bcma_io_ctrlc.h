 ...
 *
 * Functions called through this API will return immediately if Ctrl-C
 * is pressed. In case of a Ctrl-C exception, any resourses allocated
 * will be lost and any locks held will not be released.
 *
