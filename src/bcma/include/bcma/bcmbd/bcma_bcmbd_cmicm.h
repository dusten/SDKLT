/*! \file bcma_bcmbd_cmicm.h
 *
 * Common functions for bcmbd CMICm commands
 */
/*
...
#ifndef BCMA_BCMBD_CMICM_H
#define BCMA_BCMBD_CMICM_H

#include <bcmbd/bcmbd.h>
#include <bcma/bcmbd/bcma_bcmbd.h>

/*! Prototypes for CMICm hash table insert/delete/lookup functions. */
typedef int (*bcma_bcmbd_cmicm_tblop_f)(int unit, uint32_t adext, uint32_t addr,
...
/*!
 * \brief Symbolic register read/write operation for CMICm devices.
 *
...
/*!
 * \brief Symbolic Memory read/write operation for CMICm devices.
 *
...
/*!
 * \brief Perform symbolic register and memory operations for CMICm devices.
 *
 * This function will perform symbolic register or memory operation
 * for CMICm units. The information of modification targets is retrieved from
...
/*!
 * \brief Perform symbolic hash table insert for CMICm devices.
 *
 * This function will perform symbolic hash table insert
 * operation for CMICm units. The information of modification targets is
...
/*!
 * \brief Perform symbolic hash table delete for CMICm devices.
 *
...
/*!
 * \brief Perform symbolic hash table lookup for CMICm devices.
 *
