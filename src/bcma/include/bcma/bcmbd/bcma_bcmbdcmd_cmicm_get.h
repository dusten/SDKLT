/*! \file bcma_bcmbdcmd_cmicm_get.h
 *
...
#ifndef BCMA_BCMBDCMD_CMICM_GET_H
#define BCMA_BCMBDCMD_CMICM_GET_H

#include <bcma/cli/bcma_cli.h>

/*! Brief description for CLI command. */
#define BCMA_BCMBDCMD_CMICM_GET_DESC \
    "Get chip register/memory contents"

/*! Syntax for CLI command. */
#define BCMA_BCMBDCMD_CMICM_GET_SYNOP \
    "expr [nz] [raw] [flags=symflags]"

/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICM_GET_HELP \
...
/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICM_GET_HELP_2 \
    ...
    "register, port, counter, memory, r64, big-endian, soft-port, memmapped." \
    "\n\n" \
    "Examples:\n\n" \
    "get GMACC1r.0\n" \
...
/*!
 * \brief CLI 'get' command implementation for CMICm.
 *
...
#endif /* BCMA_BCMBDCMD_CMICM_GET_H */
