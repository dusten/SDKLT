/*! \file bcma_bcmbdcmd_cmicm_seti.h
 *
...
#ifndef BCMA_BCMBDCMD_CMICM_SETI_H
#define BCMA_BCMBDCMD_CMICM_SETI_H

#include <bcma/cli/bcma_cli.h>

/*! Brief description for CLI command. */
#define BCMA_BCMBDCMD_CMICM_SETI_DESC \
    "Modify chip register/memory contents (raw)"

/*! Syntax for CLI command. */
#define BCMA_BCMBDCMD_CMICM_SETI_SYNOP \
    "access-type addr value[:value2[:value3 ... ]] [size]"

/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICM_SETI_HELP \
...
/*!
 * \brief CLI 'seti' command implementation for CMICm.
 *
...
#endif /* BCMA_BCMBDCMD_CMICM_SETI_H */
