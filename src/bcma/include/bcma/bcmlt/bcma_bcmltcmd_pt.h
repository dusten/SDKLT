...
#define BCMA_BCMLTCMD_PT_HELP \
    ...
    "<entry_op> := <op> [<field>=<val> ...]\n" \
    "\n" \
    "The <table_op> performs physical table operation(s) through an entry\n" \
    "in the given physical table <name>.\n" \
    "\n" \
    "<ATTR>: attr=<attr>[,<attr>...]\n" \
    "  Currently supported <attr> is CACHE_BYPASS.\n" \
    "\n" \
    "The valid <op>s in table <entry_op> are: set, get, modify and lookup.\n" \
    "\n" \
    ...
    "pt list TDM\n" \
    "pt list -l ^TDM\n" \
    "pt VRFm set FLEX_CTR_BASE_COUNTER_IDX=0x123 BCMLTM_PT_INDEX=0\n" \
    "pt VRFm attr=CACHE_BYPASS get BCMLTM_PT_INDEX=0"
