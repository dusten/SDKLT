...
/*! Default local environement variable name for command execution result. */
 ...
 *
 * Variable will be deleted if 'value' is NULL. Otherwise variable will be
 * update or added by 'value'.
 *
 * \param [in] cli CLI object
 * \param [in] name Variable name
 ...
 */
extern int
bcma_cli_var_set(bcma_cli_t *cli, const char *name, char *value, int local);
 ...
 * default behavior is defined if no call-back is installed.
 *
 * If the environment variable is not set, the 'deflt' value will be returned.
 * The return value will be FALSE if variable 'name' is set to '0' or 'false'.
