...
#ifndef BCMA_BCMPKTCMD_DEV_H
#define BCMA_BCMPKTCMD_DEV_H

#include <bcma/cli/bcma_cli.h>

/*! Brief description for CLI command. */
#define BCMA_BCMPKTCMD_DEV_DESC \
    "Manage packet device."

/*! Syntax for CLI command. */
#define BCMA_BCMPKTCMD_DEV_SYNOP \
    "[<resource>] <action> [<id>] [options]"

/*! Help for CLI command. */
#define BCMA_BCMPKTCMD_DEV_HELP \
    ...
    "Examples:\n" \
    "pktdev init\n" \
    "pktdev i n=\"bcm1\" defpath=yes\n" \
    "pktdev chan set 0 dir=TX ringsize=32\n" \
    "pktdev chan qm 1 hw=0xffff lw=0xfffffff\n"
