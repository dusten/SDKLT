...
static bcma_cli_command_t cmd_lt = {
    "lt",
    bcma_bcmltcmd_lt,
    BCMA_BCMLTCMD_LT_DESC,
    BCMA_BCMLTCMD_LT_SYNOP,
...
static bcma_cli_command_t cmd_pt = {
    "pt",
    bcma_bcmltcmd_pt,
    BCMA_BCMLTCMD_PT_DESC,
    BCMA_BCMLTCMD_PT_SYNOP,
    { BCMA_BCMLTCMD_PT_HELP }
};

static bcma_cli_command_t cmd_ltcapture = {
    "LtCAPture",
    bcma_bcmltcmd_ltcapture,
    BCMA_BCMLTCMD_LTCAPTURE_DESC,
    BCMA_BCMLTCMD_LTCAPTURE_SYNOP,
    { BCMA_BCMLTCMD_LTCAPTURE_HELP }
};
...
int
bcma_bcmltcmd_cleanup(bcma_cli_t *cli)
{
    bcma_bcmltcmd_ltcapture_cleanup(cli);
