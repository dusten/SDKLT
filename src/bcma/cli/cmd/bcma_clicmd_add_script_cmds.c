...
static bcma_cli_command_t cmd_echo = {
    "echo",
    bcma_clicmd_echo,
    BCMA_CLICMD_ECHO_DESC,
    BCMA_CLICMD_ECHO_SYNOP,
    { BCMA_CLICMD_ECHO_HELP }
};

static bcma_cli_command_t cmd_loop = {
    "loop",
    bcma_clicmd_loop,
    BCMA_CLICMD_LOOP_DESC,
    BCMA_CLICMD_LOOP_SYNOP,
    { BCMA_CLICMD_LOOP_HELP }
};

static bcma_cli_command_t cmd_for = {
    "for",
    bcma_clicmd_for,
    BCMA_CLICMD_FOR_DESC,
    BCMA_CLICMD_FOR_SYNOP,
...
static bcma_cli_command_t cmd_case = {
    "case",
    bcma_clicmd_case,
    BCMA_CLICMD_CASE_DESC,
    BCMA_CLICMD_CASE_SYNOP,
    { BCMA_CLICMD_CASE_HELP }
};

static bcma_cli_command_t cmd_expr = {
    "expr",
    bcma_clicmd_expr,
    BCMA_CLICMD_EXPR_DESC,
    BCMA_CLICMD_EXPR_SYNOP,
    { BCMA_CLICMD_EXPR_HELP }
};

static bcma_cli_command_t cmd_delay = {
    "delay",
    bcma_clicmd_delay,
    BCMA_CLICMD_DELAY_DESC,
    BCMA_CLICMD_DELAY_SYNOP,
    { BCMA_CLICMD_DELAY_HELP }
};

static bcma_cli_command_t cmd_sleep = {
    "sleep",
    bcma_clicmd_sleep,
    BCMA_CLICMD_SLEEP_DESC,
    BCMA_CLICMD_SLEEP_SYNOP,
    { BCMA_CLICMD_SLEEP_HELP }
};
