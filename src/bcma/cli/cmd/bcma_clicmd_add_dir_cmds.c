...
static bcma_cli_command_t cmd_mkdir = {
    "mkdir",
    bcma_clicmd_mkdir,
    BCMA_CLICMD_MKDIR_DESC,
    BCMA_CLICMD_MKDIR_SYNOP,
};

static bcma_cli_command_t cmd_rmdir = {
    "rmdir",
    bcma_clicmd_rmdir,
    BCMA_CLICMD_RMDIR_DESC,
    BCMA_CLICMD_RMDIR_SYNOP,
    { BCMA_CLICMD_RMDIR_HELP }
};
