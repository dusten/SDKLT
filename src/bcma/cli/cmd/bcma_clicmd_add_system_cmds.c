...
static bcma_cli_command_t cmd_version = {
    "version",
    bcma_clicmd_version,
    BCMA_CLICMD_VERSION_DESC,
};

static bcma_cli_command_t cmd_shell = {
    "shell",
    bcma_clicmd_shell,
    BCMA_CLICMD_SHELL_DESC,
};

static bcma_cli_command_t cmd_grep = {
    "grep",
    bcma_clicmd_grep,
    BCMA_CLICMD_GREP_DESC,
    BCMA_CLICMD_GREP_SYNOP,
    { BCMA_CLICMD_GREP_HELP }
};

static bcma_cli_command_t cmd_sort = {
    "sort",
    bcma_clicmd_sort,
    BCMA_CLICMD_SORT_DESC,
    BCMA_CLICMD_SORT_SYNOP,
    { BCMA_CLICMD_SORT_HELP }
};
