...
static bcma_cli_command_t cmd_printenv = {
    "printenv",
    bcma_envcmd_printenv,
    BCMA_ENVCMD_PRINTENV_DESC
};

static bcma_cli_command_t cmd_setenv = {
    "setenv",
    bcma_envcmd_setenv,
    BCMA_ENVCMD_SETENV_DESC,
    BCMA_ENVCMD_SETENV_SYNOP,
    { BCMA_ENVCMD_SETENV_HELP }
};

static bcma_cli_command_t cmd_local = {
    "local",
    bcma_envcmd_local,
    BCMA_ENVCMD_LOCAL_DESC,
    BCMA_ENVCMD_LOCAL_SYNOP,
    { BCMA_ENVCMD_LOCAL_HELP }
};
