...
static bcma_cli_command_t shcmd_get = {
    "get",
    bcma_bcmbdcmd_cmicx_get,
    BCMA_BCMBDCMD_CMICX_GET_DESC,
    BCMA_BCMBDCMD_CMICX_GET_SYNOP,
...
static bcma_cli_command_t shcmd_set = {
    "set",
    bcma_bcmbdcmd_cmicx_set,
    BCMA_BCMBDCMD_CMICX_SET_DESC,
    BCMA_BCMBDCMD_CMICX_SET_SYNOP,
    { BCMA_BCMBDCMD_CMICX_SET_HELP }
};

static bcma_cli_command_t shcmd_geti = {
    "geti",
    bcma_bcmbdcmd_cmicx_geti,
    BCMA_BCMBDCMD_CMICX_GETI_DESC,
    BCMA_BCMBDCMD_CMICX_GETI_SYNOP,
    { BCMA_BCMBDCMD_CMICX_GETI_HELP }
};

static bcma_cli_command_t shcmd_seti = {
    "seti",
    bcma_bcmbdcmd_cmicx_seti,
    BCMA_BCMBDCMD_CMICX_SETI_DESC,
    BCMA_BCMBDCMD_CMICX_SETI_SYNOP,
    { BCMA_BCMBDCMD_CMICX_SETI_HELP }
};

static bcma_cli_command_t shcmd_list = {
    "list",
    bcma_bcmbdcmd_cmicx_list,
    BCMA_BCMBDCMD_CMICX_LIST_DESC,
    BCMA_BCMBDCMD_CMICX_LIST_SYNOP,
    { BCMA_BCMBDCMD_CMICX_LIST_HELP }
};

static bcma_cli_command_t shcmd_insert = {
    "insert",
    bcma_bcmbdcmd_cmicx_insert,
    BCMA_BCMBDCMD_CMICX_INSERT_DESC,
    BCMA_BCMBDCMD_CMICX_INSERT_SYNOP,
    { BCMA_BCMBDCMD_CMICX_INSERT_HELP }
};

static bcma_cli_command_t shcmd_delete = {
    "delete",
    bcma_bcmbdcmd_cmicx_delete,
    BCMA_BCMBDCMD_CMICX_DELETE_DESC,
    BCMA_BCMBDCMD_CMICX_DELETE_SYNOP,
    { BCMA_BCMBDCMD_CMICX_DELETE_HELP }
};

static bcma_cli_command_t shcmd_lookup = {
    "lookup",
    bcma_bcmbdcmd_cmicx_lookup,
    BCMA_BCMBDCMD_CMICX_LOOKUP_DESC,
    BCMA_BCMBDCMD_CMICX_LOOKUP_SYNOP,
    { BCMA_BCMBDCMD_CMICX_LOOKUP_HELP }
};

static bcma_cli_command_t shcmd_pid = {
    "pid",
    bcma_bcmbdcmd_cmicx_pid,
    BCMA_BCMBDCMD_CMICX_PID_DESC,
    BCMA_BCMBDCMD_CMICX_PID_SYNOP,
    { BCMA_BCMBDCMD_CMICX_PID_HELP }
};
