/*! \file bcma_bcmbdcmd_cmicm_geti.c
 *
...
geti_reg(bcma_cli_args_t *args)
{
    ...
    sal_sprintf(sid.addr.name, "0x%03"PRIx32"%08"PRIx32"",
                sid.addr.ext32, sid.addr.name32);

    /* Output all matching registers */
    return bcma_bcmbd_cmicm_regops(unit, NULL, -1, &sid, size, NULL, NULL);
}
...
geti_mem(bcma_cli_args_t *args)
{
     ...
     */
    return bcma_bcmbd_cmicm_memops(unit, NULL, -1, &sid, size, NULL, NULL);
}
