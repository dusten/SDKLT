/*! \file bcma_bcmbdcmd_cmicm_insert.c
 *
 * CLI 'insert' command for CMICm
 */
/*
...
iter_op(const bcmdrd_symbol_t *symbol, bcmdrd_sid_t symbol_id, void *vptr)
{
    ...
    bcma_bcmbd_cmicm_tbl_insert(unit, symbol, &sid, and_masks, or_masks);

    return 0;
}

static int
cmicm_insert(bcma_cli_t *cli, bcma_cli_args_t *args,
...
int
bcma_bcmbdcmd_cmicm_insert(bcma_cli_t *cli, bcma_cli_args_t *args)
{
    ...
    rv = cmicm_insert(cli, args, ctoks, ctoks_num);
