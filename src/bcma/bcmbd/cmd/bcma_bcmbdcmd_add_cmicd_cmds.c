...
static bcma_cli_command_t shcmd_get = {
    "get",
    bcma_bcmbdcmd_cmicd_get,
    BCMA_BCMBDCMD_CMICD_GET_DESC,
    BCMA_BCMBDCMD_CMICD_GET_SYNOP,
...
static bcma_cli_command_t shcmd_set = {
    "set",
    bcma_bcmbdcmd_cmicd_set,
    BCMA_BCMBDCMD_CMICD_SET_DESC,
    BCMA_BCMBDCMD_CMICD_SET_SYNOP,
    { BCMA_BCMBDCMD_CMICD_SET_HELP }
};

static bcma_cli_command_t shcmd_geti = {
    "geti",
    bcma_bcmbdcmd_cmicd_geti,
    BCMA_BCMBDCMD_CMICD_GETI_DESC,
    BCMA_BCMBDCMD_CMICD_GETI_SYNOP,
    { BCMA_BCMBDCMD_CMICD_GETI_HELP }
};

static bcma_cli_command_t shcmd_seti = {
    "seti",
    bcma_bcmbdcmd_cmicd_seti,
    BCMA_BCMBDCMD_CMICD_SETI_DESC,
    BCMA_BCMBDCMD_CMICD_SETI_SYNOP,
    { BCMA_BCMBDCMD_CMICD_SETI_HELP }
};

static bcma_cli_command_t shcmd_list = {
    "list",
    bcma_bcmbdcmd_cmicd_list,
    BCMA_BCMBDCMD_CMICD_LIST_DESC,
    BCMA_BCMBDCMD_CMICD_LIST_SYNOP,
    { BCMA_BCMBDCMD_CMICD_LIST_HELP }
};

static bcma_cli_command_t shcmd_insert = {
    "insert",
    bcma_bcmbdcmd_cmicd_insert,
    BCMA_BCMBDCMD_CMICD_INSERT_DESC,
    BCMA_BCMBDCMD_CMICD_INSERT_SYNOP,
    { BCMA_BCMBDCMD_CMICD_INSERT_HELP }
};

static bcma_cli_command_t shcmd_delete = {
    "delete",
    bcma_bcmbdcmd_cmicd_delete,
    BCMA_BCMBDCMD_CMICD_DELETE_DESC,
    BCMA_BCMBDCMD_CMICD_DELETE_SYNOP,
    { BCMA_BCMBDCMD_CMICD_DELETE_HELP }
};

static bcma_cli_command_t shcmd_lookup = {
    "lookup",
    bcma_bcmbdcmd_cmicd_lookup,
    BCMA_BCMBDCMD_CMICD_LOOKUP_DESC,
    BCMA_BCMBDCMD_CMICD_LOOKUP_SYNOP,
    { BCMA_BCMBDCMD_CMICD_LOOKUP_HELP }
};

static bcma_cli_command_t shcmd_pid = {
    "pid",
    bcma_bcmbdcmd_cmicd_pid,
    BCMA_BCMBDCMD_CMICD_PID_DESC,
    BCMA_BCMBDCMD_CMICD_PID_SYNOP,
    { BCMA_BCMBDCMD_CMICD_PID_HELP }
};
