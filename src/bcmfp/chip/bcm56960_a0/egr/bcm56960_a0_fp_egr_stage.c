/*! \file bcm56960_a0_fp_egr_stage.c
 *
 * API to initialize Egress FP stage attributes for Tomahawk(56960_A0)
 * device.
 */
/*
                                     ...
                                     bcmfp_stage_t *stage)
{
    ...
    BCMFP_ALLOC(hw_entry_info,
                ...
                "Hardware entry info for single wide group in egress");
    ...
    BCMFP_ALLOC(hw_entry_info,
                sizeof(bcmfp_stage_hw_entry_info_t),
                "Hardware entry info for dblinter wide group in egress");
    hw_entry_info->sid = EFP_TCAMm;
    hw_entry_info->sid_data_only = EFP_POLICY_TABLEm;
    hw_entry_info->key_fid = KEYf;
    hw_entry_info->mask_fid = MASKf;
    ...
    BCMFP_ALLOC(stage->misc_info,
                ...
                "Egress Stage miscellaneous information");
