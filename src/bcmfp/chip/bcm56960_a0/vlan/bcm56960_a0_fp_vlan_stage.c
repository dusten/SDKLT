/*! \file bcm56960_a0_fp_vlan_stage.c
 *
 * API to initialize VLAN FP stage attributes for Tomahawk(56960_A0) device.
 */
/*
                                     ...
                                     bcmfp_stage_t *stage)
{
    ...
    stage->flags |= (BCMFP_STAGE_KEY_TYPE_SELCODE
    ...
    BCMFP_ALLOC(hw_entry_info,
                ...
                "Hardware entry info for single wide group in vfp");
    ...
    BCMFP_ALLOC(hw_entry_info,
                sizeof(bcmfp_stage_hw_entry_info_t),
                "Hardware entry info for dblintra wide group in vfp");
    hw_entry_info->sid = VFP_TCAMm;
    hw_entry_info->sid_data_only = VFP_POLICY_TABLEm;
    hw_entry_info->key_fid = KEYf;
    hw_entry_info->mask_fid = MASKf;
    ...
    BCMFP_ALLOC(hw_entry_info,
                sizeof(bcmfp_stage_hw_entry_info_t),
                "Hardware entry info for dblinter wide group in vfp");
    hw_entry_info->sid = VFP_TCAMm;
    hw_entry_info->sid_data_only = VFP_POLICY_TABLEm;
    hw_entry_info->key_fid = KEYf;
    hw_entry_info->mask_fid = MASKf;
    ...
    BCMFP_ALLOC(hw_entry_info,
                sizeof(bcmfp_stage_hw_entry_info_t),
                "Hardware entry info for quad wide group in vfp");
    hw_entry_info->sid = VFP_TCAMm;
    hw_entry_info->sid_data_only = VFP_POLICY_TABLEm;
    hw_entry_info->key_fid = KEYf;
    hw_entry_info->mask_fid = MASKf;
    ...
    BCMFP_ALLOC(stage->misc_info,
                ...
                "VLAN Stage miscellaneous information");
