/*! \file bcm56960_a0_fp_vlan_misc.c
 *
 * APIs for chip specific miscellanious information
 * for VFP stage.
 */
/*
...
STATIC bcmfp_qual_t udf_qual_id[2][8] =
    {
         {
                                       ...
                                       bcmfp_qual_t *qual_id)
{
    ...
    SHR_NULL_CHECK(qual_id, SHR_E_PARAM);

    if (udf_chunk_id > 15) {
        SHR_RETURN_VAL_EXIT(SHR_E_PARAM);
    }

    udf_id = udf_chunk_id / 8;
    udf_chunk_id = udf_chunk_id % 8;

    *qual_id = udf_qual_id[udf_id][udf_chunk_id];
