...
static int
bcmfp_egr_misc_init(int unit, bcmfp_stage_t *stage) {
    ...
    BCMFP_RET_VAL_ASSIGN
            (bcmlrd_field_get(unit,
                              FP_EGR_ENTRYt,
                              FP_EGR_ENTRYt_FP_EGR_ENTRY_IDf,
                              &field_data));
...
bcmfp_egress_cleanup(int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcmfp_stage_get(unit, BCMFP_STAGE_ID_EGRESS, &stage));
    if (stage == NULL) {
        SHR_RETURN_VAL_EXIT(SHR_E_NONE);
    }
    ...
    SHR_IF_ERR_EXIT(bcmfp_stage_set(unit, BCMFP_STAGE_ID_EGRESS, NULL));
...
bcmfp_egress_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcmfp_egr_misc_init(unit, stage));
