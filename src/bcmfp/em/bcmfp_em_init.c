...
static int
bcmfp_em_misc_init(int unit, bcmfp_stage_t *stage) {
...
bcmfp_em_cleanup(int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcmfp_stage_set(unit, BCMFP_STAGE_ID_EXACT_MATCH, NULL));
...
bcmfp_em_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcmfp_em_misc_init(unit, stage));
