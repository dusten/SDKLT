/*! \file bcmfp_vlan_entry_map.c
 *
 * APIs for Vlan Entry LT Initialization
 *
 * This file contains function definitions for Vlan FP Entry LT
 * initialization.
 */
/*
...
bcmfp_lt_entry_sp_fids_t bcmfp_vlan_entry_sp_fids = {
    .oprtnl_state_fid = FP_VLAN_ENTRYt_OPERATIONAL_STATEf,
    .entry_id_fid = FP_VLAN_ENTRYt_FP_VLAN_ENTRY_IDf,
    ...
    .ctr_id_fid = FP_VLAN_ENTRYt_FP_VLAN_CTR_IDf
};
                     ...
                     bcmfp_lt_info_t *lt_info)
{
    ...
    lt_info->flags |= BCMFP_LT_FLAGS_NO_METER_SUPPORT;
    lt_info->map_get = NULL;
    lt_info->key_fid = FP_VLAN_ENTRYt_FP_VLAN_ENTRY_IDf;
    lt_info->sp_fids = (void *) &bcmfp_vlan_entry_sp_fids;
    lt_info->comp_id = BCMMGMT_FP_COMP_ID;
    lt_info->sub_id = BCMFP_LT_IMM_SUBID_VLAN_ENTRY;
