/*! \file bcmfp_egr_entry_map.c
 *
 * APIs for Egress Entry LT Initialization
 *
 * This file contains function definitions for Egress FP Entry LT
 * initialization.
 */
/*
...
/*! Egress FP Entry Field Identifiers that needs individual handling. */
bcmfp_lt_entry_sp_fids_t bcmfp_egr_entry_sp_fids = {
    .oprtnl_state_fid = FP_EGR_ENTRYt_OPERATIONAL_STATEf,
    .entry_id_fid = FP_EGR_ENTRYt_FP_EGR_ENTRY_IDf,
    ...
    .meter_id_fid = FP_EGR_ENTRYt_METER_FP_EGR_TEMPLATE_IDf,
    .ctr_id_fid = FP_EGR_ENTRYt_FP_EGR_CTR_IDf
};
                     ...
                     bcmfp_lt_info_t *lt_info)
{
    ...
    lt_info->key_fid = FP_EGR_ENTRYt_FP_EGR_ENTRY_IDf;
    lt_info->sp_fids = (void *) &bcmfp_egr_entry_sp_fids;
    lt_info->comp_id = BCMMGMT_FP_COMP_ID;
    lt_info->sub_id = BCMFP_LT_IMM_SUBID_EGR_ENTRY;
