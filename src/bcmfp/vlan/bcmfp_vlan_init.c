...
static int
bcmfp_vlan_misc_init(int unit, bcmfp_stage_t *stage) {
    ...
    BCMFP_RET_VAL_ASSIGN
            (bcmlrd_field_get(unit,
                              FP_VLAN_ENTRYt,
                              FP_VLAN_ENTRYt_FP_VLAN_ENTRY_IDf,
                              &field_data));
...
bcmfp_vlan_cleanup(int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcmfp_stage_set(unit, BCMFP_STAGE_ID_LOOKUP, NULL));
...
bcmfp_vlan_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcmfp_vlan_misc_init(unit, stage));
