...
static sbusdma_ctrl_t sbusdma_ctrl[BCMDRD_CONFIG_MAX_UNITS];
static fifodma_ctrl_t fifodma_ctrl[BCMDRD_CONFIG_MAX_UNITS];
static ccmdma_ctrl_t ccmdma_ctrl[BCMDRD_CONFIG_MAX_UNITS];
static schanfifo_ctrl_t schanfifo_ctrl[BCMDRD_CONFIG_MAX_UNITS];
