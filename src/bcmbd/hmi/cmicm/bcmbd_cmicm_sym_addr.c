 ...
 */
static int
bcmbd_cmicm_sym_addr(shr_pb_t *pb, int unit, uint32_t sym_flags,
...
{
    return bcmbd_cmicm_dump_addr_func_set(unit, bcmbd_cmicm_sym_addr);
}
