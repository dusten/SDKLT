...
#ifndef BCMBD_CMICM_SCHAN_H
#define BCMBD_CMICM_SCHAN_H
...
#define SCMH_ACCTYPE_GET(d)     F32_GET(d,14,3)
#define SCMH_ACCTYPE_SET(d,v)   F32_SET(d,14,3,v)
#define SCMH_DSTBLK_GET(d)      F32_GET(d,20,6)
#define SCMH_DSTBLK_SET(d,v)    F32_SET(d,20,6,v)
...
extern int bcmbd_cmicm_schan_op(int unit, schan_msg_t *msg,
                                int dwc_write, int dwc_read); 

/*! \endcond */

#endif  /* BCMBD_CMICM_SCHAN_H */
