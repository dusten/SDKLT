...
#define CMIC_CMC_IRQ_STAT1r_AXIIC_INTRf_GET(r) ((((r).cmic_cmc_irq_stat1[0]) >> 6) & 0x1)
#define CMIC_CMC_IRQ_STAT1r_AXIIC_INTRf_SET(r,f) (r).cmic_cmc_irq_stat1[0]=(((r).cmic_cmc_irq_stat1[0] & ~((uint32_t)0x1 << 6)) | ((((uint32_t)f) & 0x1) << 6))
#define CMIC_CMC_IRQ_STAT1r_LED_INTRf_GET(r) ((((r).cmic_cmc_irq_stat1[0]) >> 7) & 0x1)
#define CMIC_CMC_IRQ_STAT1r_LED_INTRf_SET(r,f) (r).cmic_cmc_irq_stat1[0]=(((r).cmic_cmc_irq_stat1[0] & ~((uint32_t)0x1 << 7)) | ((((uint32_t)f) & 0x1) << 7))
