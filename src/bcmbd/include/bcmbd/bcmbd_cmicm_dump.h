...
#ifndef BCMBD_CMICM_DUMP_H
#define BCMBD_CMICM_DUMP_H
 ...
 */
extern void
bcmbd_cmicm_dump_data(shr_pb_t *pb,
 ...
 */
extern void
bcmbd_cmicm_dump_reg(shr_pb_t *pb, int unit,
                     uint32_t adext, uint32_t addr,
                     uint32_t *data, size_t wsize);
 ...
 */
extern void
bcmbd_cmicm_dump_mem(shr_pb_t *pb, int unit,
                     uint32_t adext, uint32_t addr,
                     uint32_t *data, size_t wsize);
 ...
 */
extern int
bcmbd_cmicm_dump_addr_func_set(int unit, bcmbd_dump_addr_f dump_addr_func);

#endif /* BCMBD_CMICM_DUMP_H */
