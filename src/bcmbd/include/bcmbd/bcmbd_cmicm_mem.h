/*! \file bcmbd_cmicm_mem.h
 *
 * Programmed I/O access to SOC memory on CMICm-based device.
...
#ifndef BCMBD_CMICM_MEM_H
#define BCMBD_CMICM_MEM_H
 ...
 */
extern int
bcmbd_cmicm_mem_read(int unit, uint32_t adext, uint32_t addr,
 ...
 */
extern int
bcmbd_cmicm_mem_write(int unit, uint32_t adext, uint32_t addr,
                      uint32_t *data, size_t wsize);

#endif /* BCMBD_CMICM_MEM_H */
