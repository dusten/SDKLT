/*! \file bcmbd_cmicm_reg.h
 *
 * Programmed I/O access to SOC register on CMICm-based device.
 * Also applicable to CMICd-based (v1) devices.
 */
/*
...
#ifndef BCMBD_CMICM_REG_H
#define BCMBD_CMICM_REG_H
 ...
 * \param [in] addr Base address (bits [32:0]).
 ...
 */
extern int
bcmbd_cmicm_reg_read(int unit, uint32_t adext, uint32_t addr,
 ...
 */
extern int
bcmbd_cmicm_reg_write(int unit, uint32_t adext, uint32_t addr,
                      uint32_t *data, size_t wsize);

#endif /* BCMBD_CMICM_REG_H */
