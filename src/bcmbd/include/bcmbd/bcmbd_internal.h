...
#include "bcmbd_sbusdma_internal.h"
#include "bcmbd_fifodma_internal.h"
#include "bcmbd_ccmdma_internal.h"
#include "bcmbd_schanfifo_internal.h"
...
/*!
 * \brief Get configuration property value in uint64_t format.
 *
 * \param [in] unit Unit number.
 * \param [in] cfg_str Configuration property string, case sensitive.
 * \param [out] val Configuration value of the string.
 * \param [in] def_val Default value used if configuration property doesn't exist.
 *
 * \return Nothing.
 */
extern void
bcmbd_config_uint64_get(int unit, const char *cfg_str, uint64_t *val, uint64_t def_val);
