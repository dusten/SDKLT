...
#ifndef BCMECMP_LTH_GROUP_H
#define BCMECMP_LTH_GROUP_H
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table traverse function to
 * get first entry.
 *
