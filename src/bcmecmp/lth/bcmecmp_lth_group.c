/*! \file bcmecmp_lth_group.c
 *
 * ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table handler functions.
 */
/*
...
#include <bcmecmp/bcmecmp_lth_group.h>
 ...
 */
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL LT entry fields print function.
 *
 * Debug ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table entry fields and values
 * print function.
 *
 ...
 */
static int
bcmecmp_ltd_fields_print(int unit,
 ...
 */
static int
bcmecmp_lt_fields_parse(int unit,
                        ...
                        bcmecmp_lt_entry_t *lt_entry)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "bcmecmp_lt_fields_parse:CNT=%d LT_SID=%d.\n"),
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table input fields validate.
 *
 ...
 */
int
bcmecmp_lth_group_validate(int unit,
                           ...
                           const bcmltd_generic_arg_t *arg)
{
     ...
     * resolution mode.
     */
    if (arg->sid != BCMECMP_TBL_LTD_SID(unit, group, BCMECMP_GRP_TYPE_SINGLE)) {
        LOG_VERBOSE(BSL_LOG_MODULE,
                    (BSL_META_U(unit,
    ...
    LOG_DEBUG(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "rv=%d"),
                bcmecmp_ltd_fields_print(unit, in, 1)));
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmecmp_lt_fields_parse(unit, in, arg->sid, lt_entry));
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table entry insert.
 *
 * Inserts an entry into ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table.
 *
 * \param [in] unit Unit number.
 ...
 */
int
bcmecmp_lth_group_insert(int unit,
                         uint32_t trans_id,
                         const bcmltd_fields_t *in,
                         const bcmltd_generic_arg_t *arg)
{
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcmecmp_lth_group_insert: LT_SID=%d.\n"),
              arg->sid));
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table entry lookup.
 *
 * Lookup an entry in ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table and
 ...
 */
int
bcmecmp_lth_group_lookup(int unit,
                         uint32_t trans_id,
                         const bcmltd_fields_t *in,
                         bcmltd_fields_t *out,
                         const bcmltd_generic_arg_t *arg)
{
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcmecmp_lth_group_lookup: LT_SID=%d.\n"),
              arg->sid));
    ...
    /* Retrieve group information from hardware tables. */
    ...
    if (SHR_E_NONE == rv) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmecmp_lt_fields_populate(unit, lt_entry, FALSE, out));
        ...
        LOG_DEBUG(BSL_LOG_MODULE,
                    (BSL_META_U(unit,
                                "rv=%d"),
                    bcmecmp_ltd_fields_print(unit, out, 0)));
    } else {
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table entry delete.
 *
 * Delete an entry from ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table.
 *
 * \param [in] unit Unit number.
 * \param [in] trans_id Transaction identifier.
 * \param [in] in Input field values.
 ...
 */
int
bcmecmp_lth_group_delete(int unit,
                         uint32_t trans_id,
                         const bcmltd_fields_t *in,
                         const bcmltd_generic_arg_t *arg)
{
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcmecmp_lth_group_delete: LT_SID=%d.\n"),
              arg->sid));
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table entry update.
 *
 * Update an existing entry in ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table.
 *
 * \param [in] unit Unit number.
 * \param [in] trans_id Transaction identifier.
 * \param [in] in Input field values.
 ...
 */
int
bcmecmp_lth_group_update(int unit,
                         uint32_t trans_id,
                         const bcmltd_fields_t *in,
                         const bcmltd_generic_arg_t *arg)
{
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcmecmp_lth_group_update: LT_SID=%d.\n"),
              arg->sid));
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table get first entry.
 *
 * Traverses ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table and returns
 * key-field and data-field values of the first entry found in this logical
 * table.
 *
 * \param [in] unit Unit number.
 * \param [in] trans_id Transaction identifier.
 ...
 */
int
bcmecmp_lth_group_first(int unit,
                        uint32_t trans_id,
                        bcmltd_fields_t *out,
                        const bcmltd_generic_arg_t *arg)
{
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcmecmp_lth_group_first: LT_SID=%d.\n"),
              arg->sid));
     ...
     * resolution mode.
     */
    if (arg->sid != BCMECMP_TBL_LTD_SID
    ...
    /* Find the first valid entry configured in this ECMP logical table. */
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table get next entry.
 *
 * Traverses ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table starting from the
 ...
 */
int
bcmecmp_lth_group_next(int unit,
                       uint32_t trans_id,
                       const bcmltd_fields_t *in,
                       bcmltd_fields_t *out,
                       const bcmltd_generic_arg_t *arg)
{
    const char *const mode[BCMECMP_MODE_COUNT] = BCMECMP_MODE_NAME;
    bcmecmp_lt_entry_t *lt_entry = NULL; /* Out ECMP LT entry data ptr. */
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcmecmp_lth_group_next: LT_SID=%d.\n"),
              arg->sid));
    ...
    BCMECMP_ALLOC(in_entry, sizeof(*in_entry), "bcmecmpLthGrpNxtInEnt");
    ...
    /* Parse the input fields and retrieve the field values. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmecmp_lt_fields_parse(unit, in, arg->sid, in_entry));
    ...
    /* Find the next entry in this ECMP logical table. */
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table transaction commit
 * function.
 *
 ...
 */
int
bcmecmp_lth_group_commit(int unit,
                         uint32_t trans_id,
                         const bcmltd_generic_arg_t *arg)
{
    const char *const mode[BCMECMP_MODE_COUNT] = BCMECMP_MODE_NAME;
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcmecmp_lth_group_commit: LT_SID=%d.\n"),
              arg->sid));
...
/*!
 * \brief ECMP/ECMP_FAST/ECMP_HIERARCHICAL logical table transaction abort
 * function.
 *
 ...
 */
int
bcmecmp_lth_group_abort(int unit,
                        uint32_t trans_id,
                        const bcmltd_generic_arg_t *arg)
{
    const char *const mode[BCMECMP_MODE_COUNT] = BCMECMP_MODE_NAME;
