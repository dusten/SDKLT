/*! \file bcmport_internal.h
 *
 * BCM port APIs and Structures used only internally
 */
/*
...
#ifndef BCMPORT_INTERNAL_H
#define BCMPORT_INTERNAL_H
...
/*!
 * \brief Register callback functions to BCMPORT IMM LTs.
 *
 * \param [in] unit Unit number.
 *
 * \retval SHR_E_NONE No errors. Error code otherwise.
...
/*!
 * \brief Port mirror database initialization.
 *
 * \param [in] unit Unit number.
 *
 * \retval SHR_E_NONE No errors. Error code otherwise.
 ...
 * \param [in] mirror_inst Mirror instance ID.
 ...
 * \param [in] sid Logical tabld ID.
 * \param [in] trans_id The transaction ID associated with this operation.
 * \param [in] iport Ingress port number.
 * \param [in] eport Egress port number.
 * \param [in] mirror_inst Mirror instance ID.
...
/*!
 * \brief Enable/disable PORT_BRIDGE.BRIDGE.
 *
 * \param [in] unit Unit number.
 * \param [in] trans_id The transaction ID associated with this operation.
 * \param [in] lt_id Logical tabld ID.
 * \param [in] port Ingress port number.
 * \param [in] bridge Enable/disable port bridge.
 *
 * \retval SHR_E_NONE No errors. Error code otherwise.
 * \retval SHR_E_MEMORY Out of memory.
 * \retval SHR_E_PARAM Invalid parameter.
 */
extern int
bcmport_port_bridge_set(int unit, uint32_t trans_id,
                        bcmltd_sid_t lt_id, shr_port_t port, bool bridge);

/*!
 * \brief PORT_MEMBERSHIP_POLICY logical table entry insert.
 *
 * \param [in] unit Unit number.
 * \param [in] trans_id Logical Table transaction ID.
