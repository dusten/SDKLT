/*! \file port_policy_pass_on_outer_tpid_match.c
 *
...
#include <bcmport/bcmport_port_policy_pass_on_outer_tpid_match.h>
 ...
 */
int
bcmport_port_policy_pass_on_outer_tpid_match_transform(int unit,
                                                       ...
                                                       const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmport_port_policy_pass_on_outer_tpid_match_transform\n")));
 ...
 */
int
bcmport_port_policy_pass_on_outer_tpid_match_rev_transform(int unit,
                                                           const bcmltd_fields_t *in,
                                                           bcmltd_fields_t *out,
                                                           const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmport_port_policy_pass_on_outer_tpid_match_rev_transform\n")));
