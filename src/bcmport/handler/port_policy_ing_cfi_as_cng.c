/*! \file port_policy_ing_cfi_as_cng.c
 *
...
#include <bcmport/bcmport_port_policy_ing_cfi_as_cng.h>
 ...
 */
int
bcmport_port_policy_ing_cfi_as_cng_transform(int unit,
                                             ...
                                             const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmport_port_policy_ing_cfi_as_cng_transform\n")));
 ...
 */
int
bcmport_port_policy_ing_cfi_as_cng_rev_transform(int unit,
                                                 const bcmltd_fields_t *in,
                                                 bcmltd_fields_t *out,
                                                 const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmport_port_policy_ing_cfi_as_cng_rev_transform\n")));
