/*! \file port_vlan_xlate_ing_xlate_tbl_sel_second_lookup.c
 *
...
#include <bcmport/bcmport_port_vlan_xlate_ing_xlate_tbl_sel_second_lookup.h>
 ...
 */
int
bcmport_port_vlan_xlate_ing_xlate_tbl_sel_second_lookup_transform(int unit,
                                                                  ...
                                                                  const bcmltd_transform_arg_t *arg)
{
    size_t i;
    int rv = SHR_E_NONE;
    uint32_t key_type_id   = VT_KEY_TYPE_2f;
    uint32_t port_type_id  = VT_PORT_TYPE_SELECT_2f;
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmport_port_vlan_xlate_ing_xlate_tbl_sel_second_lookup_transform\n")));
 ...
 */
int
bcmport_port_vlan_xlate_ing_xlate_tbl_sel_second_lookup_rev_transform(int unit,
                                                                      const bcmltd_fields_t *in,
                                                                      bcmltd_fields_t *out,
                                                                      const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmport_port_vlan_xlate_ing_xlate_tbl_sel_second_lookup_rev_transform\n")));
