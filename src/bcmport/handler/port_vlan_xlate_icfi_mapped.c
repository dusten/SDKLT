/*! \file port_vlan_xlate_icfi_mapped.c
 *
...
#include <bcmport/bcmport_port_vlan_xlate_icfi_mapped.h>
 ...
 */
int
bcmport_port_vlan_xlate_icfi_mapped_transform(int unit,
                                              ...
                                              const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmport_port_vlan_xlate_icfi_mapped_transform\n")));
    out->count = 0;
 ...
 */
int
bcmport_port_vlan_xlate_icfi_mapped_rev_transform(int unit,
                                                  const bcmltd_fields_t *in,
                                                  bcmltd_fields_t *out,
                                                  const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmport_port_vlan_xlate_icfi_mapped_rev_transform\n")));
