...
int
bcm56960_a0_ecn_drv_attach(int unit)
{
    return bcmecn_drv_set(unit, &bcm56960_ecn_drv);
}

int
bcm56960_a0_ecn_drv_detach(int unit)
{
    return bcmecn_drv_set(unit, NULL);
}
