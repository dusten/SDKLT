/*! \file bcmmirror_imm_internal.h
 *
 * BCMMIRROR in-memory table (IMM) utilities.
 */
/*
...
#ifndef BCMMIRROR_IMM_INTERNAL_H
#define BCMMIRROR_IMM_INTERNAL_H
...
/*!
 * \brief Initialize the IMM interface for all MIRROR LTs.
 *
 ...
 *
 * \param [in] unit Unit number.
 * \param [in] drv MIRROR driver to get.
 *
 * \retval SHR_E_NONE No errors.
 */
extern int
bcmmirror_drv_get(int unit, bcmmirror_drv_t **drv);
#endif /* BCMMIRROR_IMM_INTERNAL_H */
