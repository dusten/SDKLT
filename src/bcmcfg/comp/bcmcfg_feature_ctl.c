...
static const bcmcfg_comp_node_t bcmcfg_feature_ctl_schema[] = {
    ...
    }, /* [top] 0 */
    {
        ...
        .key = "dis_stomic_trans",
        .next = BCMCFG_NO_IDX,
        .offset = offsetof(bcmcfg_feature_ctl_config_t, dis_stomic_trans),
        .size = sizeof(((bcmcfg_feature_ctl_config_t *)0)->dis_stomic_trans),
    }, /* dis_stomic_trans 1 */
};
...
const bcmcfg_feature_ctl_config_t *
bcmcfg_feature_ctl_config_get(void)
{
    return bcmcfg_feature_ctl_data;
}
