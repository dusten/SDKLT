...
#define BSL_LOG_MODULE BSL_LS_BCML2_SYSM
              ...
              uint32_t *blocking_component)
{
    ...
    if (SHR_FAILURE(bcml2_learn_ctrl_cleanup(unit))) {
        return SHR_SYSM_RV_ERROR;
    }

    if (SHR_FAILURE(bcml2_transform_detach(unit))) {
        return SHR_SYSM_RV_ERROR;
    }
                 ...
                 uint32_t *blocking_component)
{
    ...
    if (SHR_FAILURE(bcml2_learn_ctrl_init(unit, warm))) {
        return SHR_SYSM_RV_ERROR;
    }

    if (SHR_FAILURE(bcml2_transform_attach(unit))) {
        return SHR_SYSM_RV_ERROR;
    }
          ...
          uint32_t *blocking_component)
{
    ...
    if (SHR_FAILURE(bcml2_learn_ctrl_report_enable(unit, 0))) {
        return SHR_SYSM_RV_ERROR;
    }
