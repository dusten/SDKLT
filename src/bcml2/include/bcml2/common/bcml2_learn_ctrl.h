/*! \file bcml2_learn_ctrl.h
 *
 * L2 Learn Control APIs and Structures used only internally.
 */
/*
...
#ifndef BCML2_LEARN_CTRL_H
#define BCML2_LEARN_CTRL_H
