...
#ifndef BCML2_OPAQUE_TAG_ID_H
#define BCML2_OPAQUE_TAG_ID_H
 ...
 */
extern int
bcml2_opaque_tag_id_transform(int unit,
 ...
 */
extern int
bcml2_opaque_tag_id_rev_transform(int unit,
                                  const bcmltd_fields_t *in,
                                  bcmltd_fields_t *out,
                                  const bcmltd_transform_arg_t *arg);

#endif /* BCML2_OPAQUE_TAG_ID_H */
