...
#ifndef BCMTRUNK_UTIL_H
#define BCMTRUNK_UTIL_H
 ...
 */
extern int
bcmtrunk_hw_read(int unit, uint32_t trans_id,
 ...
 */
extern int
bcmtrunk_hw_write(int unit, uint32_t trans_id,
                  bcmltd_sid_t lt_id, bcmdrd_sid_t pt_id,
                  int index, void *entry_data);
 ...
 */
extern int
bcmtrunk_pt_hw_read(int unit, uint32_t trans_id,
                    bcmltd_sid_t lt_id, bcmdrd_sid_t pt_id,
                    int index, void *entry_data);
 ...
 */
extern int
bcmtrunk_pt_hw_write(int unit, uint32_t trans_id,
                     bcmltd_sid_t lt_id, bcmdrd_sid_t pt_id,
                     int index, void *entry_data);
