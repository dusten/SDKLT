/*! \file bcmtrunk_common.h
 *
 * Purpose: bcmtrunk common headfile of chips.
 */
/*
...
#ifndef BCMTRUNK_COMMON_H
#define BCMTRUNK_COMMON_H
/*******************************************************************************
 * Includes
 */
...
typedef int (*fn_grp_init_t)(int unit, bcmtrunk_lth_grp_bk_t *grp_bk);
...
typedef int (*fn_fast_grp_init_t)(int unit, bcmtrunk_lth_fgrp_bk_t *fgrp_bk);
...
typedef int (*fn_failover_init_t)(int unit,
                                  bcmtrunk_failover_bk_t *failover_bk);

typedef struct bcmtrunk_drv_s {
...
/* signature of attach function */
typedef int (*bcmtrunk_drv_attach_f)(bcmtrunk_drv_t *fn_ptrs);
...
extern int _bc##_trunk_drv_attach(bcmtrunk_drv_t *trunk_drv);
#define BCMDRD_DEVLIST_OVERRIDE
#include <bcmdrd/bcmdrd_devlist.h>
/*! \endcond */

#endif /* BCMTRUNK_COMMON_H */
