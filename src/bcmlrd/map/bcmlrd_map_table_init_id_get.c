/*! \file bcmlrd_map_table_init_id_get.c
 *
 * Get a table init ID for the given index.
 */
/*
...
bcmlrd_map_table_init_id_get(int unit, uint32_t init_idx, uint32_t *init_id)
{
    ...
    do {
        ...
        if (init_idx < conf->table_init_ids) {
            *init_id = conf->table_init_id[init_idx];
            rv = SHR_E_NONE;
        }
