/*! \file bcmltm_nc_lta_cth.h
 *
 * Logical Table Manager - Node Cookies.
 *
 * Logical Table mappings with Custom Table Handler groups definitions.
 *
 * This file contains routines to construct LT information
 * required by the LTM metadata for LT with LTA Custom Table Handlers.
 */
/*
...
#ifndef BCMLTM_NC_LTA_CTH_H
#define BCMLTM_NC_LTA_CTH_H
...
} bcmltm_nc_lta_cth_info_t;


/*!
 * \brief Create LT cookies info for Custom Table Handler for given table.
 *
 * Create the LT cookies information needed by the LTM metadata
 * for LTA Custom Table Handler.
 *
 * Currently, only 1 custom table handler is supported per LT.
 *
 * \param [in] unit Unit number.
 * \param [in] sid Table ID.
 * \param [in] map_group Customer Table Handler map information.
...
/*!
 * \brief Destroy LT cookies info for Custom Table Handler map groups.
 *
 * Destroy LT cookies info for LTA Custom Table Handler.
 *
