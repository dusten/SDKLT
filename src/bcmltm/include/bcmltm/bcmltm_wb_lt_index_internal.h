/*! \file bcmltm_wb_lt_index_internal.h
 *
 * Logical Table Manager Working Buffer Definitions for LT Index.
 */
/*
...
#ifndef BCMLTM_WB_LT_INDEX_INTERNAL_H
#define BCMLTM_WB_LT_INDEX_INTERNAL_H
...
/*!
 * \brief Add a LT Index working buffer block.
 *
 * This function adds a working buffer block required for
 * Index Logical Tables.
 *
...
/*!
 * \brief Get the LT Index working buffer offsets.
 *
 * This function gets the LT index offsets in the specified
 * LT index working buffer block.
 *
...
#endif /* BCMLTM_WB_LT_INDEX_INTERNAL_H */
