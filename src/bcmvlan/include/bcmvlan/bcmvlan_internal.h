/*! \file bcmvlan_internal.h
 *
 * Utils, defines shared across BCMVLAN sub-modules
 *
 * This file contains utils, defines shared across VLAN sub-modules
 */
/*
...
#ifndef BCMVLAN_INTERNAL_H
#define BCMVLAN_INTERNAL_H
 ...
 *
 * \retval            - SHR_E_NONE Success
 * \retval Else       - SHR_E_UNAVAIL
 */
extern int
bcmvlan_xlate_port_grp_config(int unit);

#endif /* BCMVLAN_INTERNAL_H */
